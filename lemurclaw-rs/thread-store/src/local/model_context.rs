...
use lemurclaw_rollout::ModelContextScan;
use lemurclaw_rollout::ModelContextScanProgress;
use lemurclaw_rollout::ReverseJsonlScanner;
use lemurclaw_rollout::ScanOutcome;
...
pub(super) async fn load_for_fork(
    ...
    let session_meta = lemurclaw_rollout::read_session_meta_line(source_path)
        .await
        .map_err(|err| ThreadStoreError::Internal {
            message: format!(
