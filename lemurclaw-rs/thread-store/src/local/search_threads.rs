...
use lemurclaw_rollout::first_rollout_content_match_snippet;
use lemurclaw_rollout::parse_cursor;
use lemurclaw_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: lemurclaw_rollout::ThreadItem,
    snippet: String,
}
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = lemurclaw_rollout::plain_rollout_path(item.path.as_path());
...
) -> Option<lemurclaw_rollout::Cursor> {
