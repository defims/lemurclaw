...
use chrono::DateTime;
use lemurclaw_app_server_protocol::ThreadHistoryChangeSet;
use lemurclaw_app_server_protocol::project_rollout_line;
...
pub(super) async fn materialize_to_sqlite(
    ...
    let session_meta = lemurclaw_rollout::read_session_meta_line(rollout_path)
        .await
