...
use lemurclaw_file_system::FileSystemSandboxContext;
pub use lemurclaw_file_system::WalkOptions;
pub use lemurclaw_file_system::WalkOutcome;
...
use lemurclaw_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        Self {
            shell: lemurclaw_shell_command::shell_detect::default_user_shell().into(),
...
mod tests {
    ...
    use lemurclaw_network_proxy::RemoteNetworkProxyLaunchConfig;
    use lemurclaw_protocol::config_types::WindowsSandboxProxySettingsMode;
