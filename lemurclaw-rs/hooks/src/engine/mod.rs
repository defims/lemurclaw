...
pub(crate) struct ConfiguredHandler {
    pub event_name: lemurclaw_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            lemurclaw_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            lemurclaw_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            lemurclaw_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            lemurclaw_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            lemurclaw_protocol::protocol::HookEventName::PostCompact => "post-compact",
            lemurclaw_protocol::protocol::HookEventName::SessionStart => "session-start",
            lemurclaw_protocol::protocol::HookEventName::SessionEnd => "session-end",
            lemurclaw_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            lemurclaw_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            lemurclaw_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            lemurclaw_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<lemurclaw_protocol::items::HookPromptFragment>,
    ) -> Vec<lemurclaw_protocol::items::HookPromptFragment> {
        self.output_spiller
