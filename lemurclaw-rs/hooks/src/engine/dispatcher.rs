...
pub(crate) fn completed_summary(
    ...
    entries: Vec<lemurclaw_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(source: lemurclaw_protocol::protocol::HookSource) -> &'static str {
    match source {
        lemurclaw_protocol::protocol::HookSource::System => "system",
        lemurclaw_protocol::protocol::HookSource::User => "user",
        lemurclaw_protocol::protocol::HookSource::Project => "project",
        lemurclaw_protocol::protocol::HookSource::Mdm => "mdm",
        lemurclaw_protocol::protocol::HookSource::SessionFlags => "session_flags",
        lemurclaw_protocol::protocol::HookSource::Plugin => "plugin",
        lemurclaw_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        lemurclaw_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        lemurclaw_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        lemurclaw_protocol::protocol::HookSource::LegacyManagedConfigMdm => "legacy_managed_config_mdm",
        lemurclaw_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
