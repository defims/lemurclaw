...
async fn assert_compaction_uses_turn_lifecycle_id(codex: &std::sync::Arc<lemurclaw_core::CodexThread>) {
...
async fn auto_compact_runs_after_resume_when_token_usage_is_over_limit() {
    ...
    let compacted_history = vec![
        lemurclaw_protocol::models::ResponseItem::Message {
            id: None,
        ...
        lemurclaw_protocol::models::ResponseItem::Compaction {
            id: None,
