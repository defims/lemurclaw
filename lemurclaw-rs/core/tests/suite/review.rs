...
use lemurclaw_core::REVIEW_PROMPT;
...
use lemurclaw_protocol::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;
...
use lemurclaw_protocol::protocol::ReviewCodeLocation;
use lemurclaw_protocol::protocol::ReviewFinding;
use lemurclaw_protocol::protocol::ReviewLineRange;
...
async fn review_input_isolated_from_parent_history() {
    ...
    let session_file = codex_home.path().join("resume.jsonl");
    {
        ...
        let user = lemurclaw_protocol::models::ResponseItem::Message {
            id: None,
            role: "user".to_string(),
        ...
        let assistant = lemurclaw_protocol::models::ResponseItem::Message {
            id: None,
