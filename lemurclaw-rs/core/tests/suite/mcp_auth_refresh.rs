...
use lemurclaw_login::ExternalAuth;
use lemurclaw_login::ExternalAuthFuture;
use lemurclaw_login::ExternalAuthRefreshContext;
use lemurclaw_mcp::CODEX_APPS_MCP_SERVER_NAME;
use lemurclaw_mcp::CodexAppsToolsCache;
...
async fn hosted_plugin_runtime_ps_mcp_tool_calls_use_current_auth_manager_token() -> Result<()> {
    ...
    let mut hosted_plugin_runtime_config = lemurclaw_mcp::hosted_plugin_runtime_mcp_server_config(
    ...
    *bearer_token_env_var = None;
    ...
    let plugins_manager = lemurclaw_core_plugins::PluginsManager::new(home.path().to_path_buf());
    ...
    let runtime = McpRuntime::new(McpRuntimeInput {
        ...
        codex_apps_tools_cache_key: lemurclaw_mcp::codex_apps_tools_cache_key(Some(&expected_auth)),
