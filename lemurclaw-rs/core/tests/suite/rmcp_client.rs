...
use lemurclaw_config::types::McpServerAuth;
...
use lemurclaw_exec_server::HttpRedirectPolicy;
use lemurclaw_exec_server::HttpRequestParams;
use lemurclaw_features::Feature;
use lemurclaw_login::CodexAuth;
use lemurclaw_mcp::CODEX_APPS_MCP_SERVER_NAME;
use lemurclaw_mcp::MCP_SANDBOX_STATE_META_CAPABILITY;
...
use lemurclaw_protocol::openai_models::ModelVisibility;
use lemurclaw_protocol::openai_models::ModelsResponse;
use lemurclaw_protocol::openai_models::ReasoningEffortPreset;
use lemurclaw_protocol::openai_models::TruncationPolicyConfig;
...
use lemurclaw_protocol::protocol::McpStartupStatus;
...
use lemurclaw_utils_cargo_bin::cargo_bin;
...
pub(super) fn remote_aware_environment_id() -> String {
    if is_remote_test_environment() {
        ...
        lemurclaw_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string()
    }
}
...
async fn stdio_image_responses_are_sanitized_for_text_only_model() -> anyhow::Result<()> {
        ...
        ModelsResponse {
            models: vec![ModelInfo {
                ...
                supported_reasoning_levels: vec![ReasoningEffortPreset {
                    effort: lemurclaw_protocol::openai_models::ReasoningEffort::Medium,
    ...
    fixture
        ...
        .list_models(
            ...
            lemurclaw_core::test_support::default_http_client_factory(),
        )
        .await;
...
async fn streamable_http_with_oauth_round_trip_impl() -> anyhow::Result<()> {
    ...
    let _codex_home_guard = EnvVarGuard::set("LEMURCLAW_HOME", temp_home.path().as_os_str());
