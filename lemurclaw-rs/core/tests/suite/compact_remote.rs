...
use lemurclaw_core::compact::SUMMARY_PREFIX;
use lemurclaw_features::Feature;
use lemurclaw_login::CodexAuth;
use lemurclaw_login::auth::AgentIdentityAuth;
use lemurclaw_login::auth::AgentIdentityAuthRecord;
use lemurclaw_protocol::account::PlanType as AccountPlanType;
use lemurclaw_protocol::config_types::ServiceTier;
use lemurclaw_protocol::dynamic_tools::DynamicToolCallOutputContentItem;
use lemurclaw_protocol::dynamic_tools::DynamicToolFunctionSpec;
use lemurclaw_protocol::dynamic_tools::DynamicToolNamespaceSpec;
...
use lemurclaw_protocol::protocol::RealtimeConversationRealtimeEvent;
use lemurclaw_protocol::protocol::RealtimeEvent;
use lemurclaw_protocol::protocol::RealtimeOutputModality;
...
async fn start_realtime_conversation(codex: &lemurclaw_core::CodexThread) -> Result<()> {
    codex
        .submit(Op::RealtimeConversationStart(ConversationStartParams {
            ...
            codex_response_handoff_mode:
                lemurclaw_protocol::protocol::CodexResponseHandoffMode::Thinking,
...
async fn close_realtime_conversation(codex: &lemurclaw_core::CodexThread) -> Result<()> {
...
async fn wait_for_turn_complete(codex: &lemurclaw_core::CodexThread) {
    ...
    for user in ["USER_ONE", "USER_TWO", "USER_THREE"] {
        if user == "USER_THREE" {
            core_test_support::submit_thread_settings(
                &codex,
                lemurclaw_protocol::protocol::ThreadSettingsOverrides {
