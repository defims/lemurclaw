...
use lemurclaw_core::WaitForEnvironmentToolConfig;
use lemurclaw_core::compact::SUMMARIZATION_PROMPT;
use lemurclaw_core::config::Config;
use lemurclaw_core::config::Constrained;
use lemurclaw_exec_server::CopyOptions;
use lemurclaw_exec_server::CreateDirectoryOptions;
use lemurclaw_exec_server::EnvironmentReadyInfo;
use lemurclaw_exec_server::ExecServerError;
use lemurclaw_exec_server::FileSystemSandboxContext;
use lemurclaw_exec_server::LOCAL_ENVIRONMENT_ID;
use lemurclaw_exec_server::NoiseChannelPublicKey;
use lemurclaw_exec_server::NoiseRendezvousConnectBundle;
use lemurclaw_exec_server::NoiseRendezvousConnectProvider;
use lemurclaw_exec_server::REMOTE_ENVIRONMENT_ID;
use lemurclaw_exec_server::RemoveOptions;
use lemurclaw_extension_api::ExtensionFuture;
use lemurclaw_extension_api::ExtensionRegistryBuilder;
use lemurclaw_extension_api::ThreadLifecycleContributor;
...
use lemurclaw_protocol::models::SandboxPermissions;
...
use lemurclaw_protocol::protocol::ENVIRONMENTS_INSTRUCTIONS_OPEN_TAG;
...
async fn submit_turn_with_approval_and_environments(
    ...
    let turn_environment_selections = lemurclaw_protocol::protocol::TurnEnvironmentSelections::new(
