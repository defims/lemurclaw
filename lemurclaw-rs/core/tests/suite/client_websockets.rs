...
use lemurclaw_api::WS_REQUEST_HEADER_TRACEPARENT_CLIENT_METADATA_KEY;
use lemurclaw_api::WS_REQUEST_HEADER_TRACESTATE_CLIENT_METADATA_KEY;
use lemurclaw_core::CodexResponsesMetadata;
use lemurclaw_core::ModelClient;
use lemurclaw_core::ModelClientSession;
use lemurclaw_core::Prompt;
use lemurclaw_core::ResponseEvent;
use lemurclaw_core::X_RESPONSESAPI_INCLUDE_TIMING_METRICS_HEADER;
use lemurclaw_core::test_support::with_parent_turn;
...
use lemurclaw_rollout_trace::ConversationPart;
use lemurclaw_rollout_trace::InferenceTraceContext;
use lemurclaw_rollout_trace::RawTraceEventPayload;
use lemurclaw_rollout_trace::TraceWriter;
use lemurclaw_rollout_trace::replay_bundle;
...
async fn responses_websocket_streams_request() {
    ...
    assert_eq!(
        ...
        Some(lemurclaw_login::default_client::get_codex_user_agent())
    );
    assert_eq!(
...
async fn websocket_harness_with_provider_options(
    ...
    let model_info = lemurclaw_core::test_support::construct_model_info_offline(MODEL, &config);
