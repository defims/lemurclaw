...
use lemurclaw_apply_patch::AppliedPatchDelta;
...
use lemurclaw_protocol::items::CommandExecutionStatus;
...
use lemurclaw_utils_string::truncate_middle_with_token_budget;
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = lemurclaw_apply_patch::apply_patch(
