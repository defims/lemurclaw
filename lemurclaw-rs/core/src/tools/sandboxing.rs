...
use lemurclaw_protocol::approvals::NetworkApprovalContext;
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub permissions: &'a lemurclaw_protocol::models::PermissionProfile,
    /// Canonical permissions before this host materializes workspace roots.
    pub exec_server_permissions: &'a lemurclaw_protocol::models::PermissionProfile,
