...
#[cfg(target_os = "macos")]
use lemurclaw_network_proxy::CODEX_PROXY_GIT_SSH_COMMAND_MARKER;
...
#[cfg(target_os = "macos")]
use lemurclaw_network_proxy::PROXY_GIT_SSH_COMMAND_ENV_KEY;
...
async fn test_network_proxy() -> anyhow::Result<NetworkProxy> {
    let state = lemurclaw_network_proxy::build_config_state(
