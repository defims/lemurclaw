...
use lemurclaw_execpolicy::MatchOptions;
...
use lemurclaw_protocol::protocol::NetworkPolicyRuleAction;
...
use lemurclaw_shell_command::bash::parse_shell_lc_plain_commands;
use lemurclaw_shell_command::bash::parse_shell_lc_single_command_prefix;
use lemurclaw_shell_escalation::EscalateServer;
use lemurclaw_shell_escalation::EscalationDecision;
use lemurclaw_shell_escalation::EscalationExecution;
use lemurclaw_shell_escalation::EscalationPermissions;
use lemurclaw_shell_escalation::EscalationPolicy;
use lemurclaw_shell_escalation::EscalationPolicyFuture;
use lemurclaw_shell_escalation::EscalationSession;
use lemurclaw_shell_escalation::ExecParams;
use lemurclaw_shell_escalation::ExecResult;
use lemurclaw_shell_escalation::PreparedExec;
use lemurclaw_shell_escalation::ResolvedPermissionProfile;
use lemurclaw_shell_escalation::ShellCommandExecutor;
use lemurclaw_shell_escalation::ShellCommandExecutorFuture;
use lemurclaw_shell_escalation::Stopwatch;
        ...
        Ok(stopwatch
            .pause_for(async move {
                ...
                let permission_request = PermissionRequestPayload::bash(
                    lemurclaw_shell_command::parse_command::shlex_join(&command),
                    /*description*/ None,
                );
...
struct CoreShellCommandExecutor {
    ...
    network: Option<lemurclaw_network_proxy::NetworkProxy>,
