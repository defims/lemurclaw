...
) -> lemurclaw_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => lemurclaw_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => lemurclaw_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => lemurclaw_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => lemurclaw_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => lemurclaw_tools::ToolUserShellType::Cmd,
    }
}
