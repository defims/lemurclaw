...
use lemurclaw_protocol::protocol::FileSystemAccessMode;
use lemurclaw_protocol::protocol::FileSystemPath;
use lemurclaw_protocol::protocol::FileSystemSandboxEntry;
use lemurclaw_protocol::protocol::FileSystemSandboxPolicy;
use lemurclaw_protocol::protocol::InitialHistory;
use lemurclaw_protocol::protocol::InterAgentCommunication;
use lemurclaw_protocol::protocol::NetworkSandboxPolicy;
        ...
        | ResponseInputItem::CustomToolCallOutput { output, .. } => {
            let content = match output.body {
                ...
                FunctionCallOutputBody::ContentItems(items) => {
                    lemurclaw_protocol::models::function_call_output_content_items_to_text(&items)
                        .unwrap_or_default()
                }
            };
...
async fn multi_agent_v2_spawn_fork_turns_all_rejects_agent_type_override() {
    ...
    let turn = TurnContext {
        ...
        multi_agent_version: lemurclaw_protocol::protocol::MultiAgentVersion::V2,
        ..turn
    };
