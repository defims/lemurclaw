...
use lemurclaw_analytics::PluginInstallRequestSource;
use lemurclaw_analytics::PluginInstallRequested;
use lemurclaw_analytics::PluginInstallRequestedPlugin;
...
use lemurclaw_tools::DiscoverableToolAction;
use lemurclaw_tools::DiscoverableToolType;
use lemurclaw_tools::LIST_AVAILABLE_PLUGINS_TO_INSTALL_TOOL_NAME;
use lemurclaw_tools::REQUEST_PLUGIN_INSTALL_PERSIST_ALWAYS_VALUE;
use lemurclaw_tools::REQUEST_PLUGIN_INSTALL_PERSIST_KEY;
use lemurclaw_tools::REQUEST_PLUGIN_INSTALL_TOOL_NAME;
use lemurclaw_tools::RequestPluginInstallArgs;
use lemurclaw_tools::RequestPluginInstallResult;
use lemurclaw_tools::ToolName;
use lemurclaw_tools::ToolSpec;
use lemurclaw_tools::all_requested_connectors_picked_up;
use lemurclaw_tools::build_request_plugin_install_elicitation_request;
use lemurclaw_tools::filter_request_plugin_install_discoverable_tools_for_client;
use lemurclaw_tools::verified_connector_install_completed;
...
async fn persist_disabled_install_request(
    codex_home: &lemurclaw_utils_absolute_path::AbsolutePathBuf,
    tool: &DiscoverableTool,
) -> anyhow::Result<()> {
...
async fn verify_request_plugin_install_completed(
    ...
    tool: &DiscoverableTool,
    auth: Option<&lemurclaw_login::CodexAuth>,
) -> bool {
    match tool {
