...
use lemurclaw_extension_api::ToolCall as ExtensionToolCall;
...
impl lemurclaw_extension_api::ToolContributor for ExtensionEchoContributor {
    fn tools(
        &self,
...
impl ToolExecutor<ExtensionToolCall> for ExtensionEchoExecutor {
    ...
    fn spec(&self) -> ToolSpec {
        ToolSpec::Namespace(ResponsesApiNamespace {
            ...
            tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                ...
                strict: true,
                parameters: lemurclaw_extension_api::parse_tool_input_schema(&json!({
                    "type": "object",
                    "properties": {
                        "message": { "type": "string" },
                    },
    ...
    fn handle(&self, call: ExtensionToolCall) -> lemurclaw_tools::ToolExecutorFuture<'_> {
...
impl ExtensionEchoExecutor {
    async fn handle_call(
        ...
        Ok(Box::new(lemurclaw_tools::JsonToolOutput::new(json!({
            "arguments": arguments,
            "callId": call.call_id,
...
fn mcp_runtime(tool_info: lemurclaw_mcp::ToolInfo) -> Arc<dyn CoreToolRuntime> {
    ...
    let router = ToolRouter::from_context(
        ...
        ToolRouterParams {
            ...
            extension_tool_executors: extension_tool_executors(
                &session,
                &lemurclaw_extension_api::ExtensionData::new(turn.sub_id.clone()),
            ),
            wait_for_environment_tool_config: None,
            dynamic_tools: turn.dynamic_tools.as_slice(),
        },
