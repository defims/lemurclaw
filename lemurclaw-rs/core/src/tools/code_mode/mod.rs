...
use lemurclaw_code_mode::CellId;
use lemurclaw_code_mode::CodeModeNestedToolCall;
use lemurclaw_code_mode::CodeModeSession;
use lemurclaw_code_mode::CodeModeSessionProvider;
use lemurclaw_code_mode::CodeModeToolKind;
use lemurclaw_code_mode::RuntimeResponse;
...
use lemurclaw_utils_output_truncation::formatted_truncate_text_content_items_with_policy;
use lemurclaw_utils_output_truncation::truncate_function_output_items_with_policy;
...
pub(crate) const PUBLIC_TOOL_NAME: &str = lemurclaw_code_mode::PUBLIC_TOOL_NAME;
pub(crate) const WAIT_TOOL_NAME: &str = lemurclaw_code_mode::WAIT_TOOL_NAME;
pub(crate) const DEFAULT_WAIT_YIELD_TIME_MS: u64 = lemurclaw_code_mode::DEFAULT_WAIT_YIELD_TIME_MS;
...
impl CodeModeService {
    ...
    pub(crate) async fn execute(
        &self,
        mut request: lemurclaw_code_mode::ExecuteRequest,
    ) -> Result<lemurclaw_code_mode::StartedCell, String> {
    ...
    pub(crate) async fn wait(
        &self,
        request: lemurclaw_code_mode::WaitRequest,
    ) -> Result<lemurclaw_code_mode::WaitOutcome, String> {
    ...
    pub(crate) fn mark_cell_ready_for_dispatch(&self, cell_id: &lemurclaw_code_mode::CellId) {
...
mod tests {
    ...
    use crate::tools::context::ToolPayload;
    use lemurclaw_code_mode::CodeModeToolKind;
    use lemurclaw_code_mode::ExecuteRequest;
    use lemurclaw_code_mode::FunctionCallOutputContentItem as CodeModeOutputContentItem;
    ...
    async fn missing_process_host_falls_back_to_in_process_session() {
        ...
        assert_eq!(
            response,
            RuntimeResponse::Result {
                cell_id: lemurclaw_code_mode::CellId::new("1".to_string()),
