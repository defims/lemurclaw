...
use lemurclaw_agent_graph_store::AgentGraphStore;
use lemurclaw_agent_graph_store::LocalAgentGraphStore;
...
use lemurclaw_code_mode::CodeModeSessionDelegate;
use lemurclaw_code_mode::CodeModeSessionProvider;
use lemurclaw_code_mode::CodeModeSessionProviderFuture;
use lemurclaw_code_mode::InProcessCodeModeSessionProvider;
use lemurclaw_code_mode::ProcessOwnedCodeModeSessionProvider;
...
use lemurclaw_login::default_client::CODEX_INTERNAL_ORIGINATOR_OVERRIDE_ENV_VAR;
...
use lemurclaw_thread_store::LoadThreadHistoryParams;
use lemurclaw_thread_store::LocalThreadStore;
use lemurclaw_thread_store::LocalThreadStoreConfig;
use lemurclaw_thread_store::PreparedFork;
use lemurclaw_thread_store::ReadThreadByRolloutPathParams;
use lemurclaw_thread_store::ReadThreadParams;
use lemurclaw_thread_store::StoredModelContext;
...
pub struct StartThreadOptions {
    ...
    pub dynamic_tools: Vec<lemurclaw_protocol::dynamic_tools::DynamicToolSpec>,
...
pub fn thread_store_from_config(
    ...
    match &config.experimental_thread_store {
        ThreadStoreConfig::Local => {
            ...
            {
                lemurclaw_rollout::spawn_rollout_compression_worker(config.codex_home.to_path_buf());
            }
...
impl ThreadManager {
    ...
    pub(crate) fn with_models_provider_home_and_state_for_tests(
        ...
        let thread_store: Arc<dyn ThreadStore> = Arc::new(LocalThreadStore::new(
            LocalThreadStoreConfig {
                ...
                sqlite: lemurclaw_state::SqliteConfig::new_for_testing(absolute_codex_home),
    ...
    pub async fn list_models(
        ...
        http_client_factory: lemurclaw_http_client::HttpClientFactory,
    ) -> Vec<ModelPreset> {
        self.state
            .models_manager
...
impl ThreadManagerState {
    ...
    pub(crate) async fn spawn_thread(
        ...
        thread_source: Option<ThreadSource>,
        dynamic_tools: Vec<lemurclaw_protocol::dynamic_tools::DynamicToolSpec>,
        metrics_service_name: Option<String>,
        parent_trace: Option<W3cTraceContext>,
    ...
    async fn parent_rollout_thread_trace_for_source(
        ...
        session_source: &SessionSource,
        initial_history: &InitialHistory,
    ) -> lemurclaw_rollout_trace::ThreadTraceContext {
        ...
        let SessionSource::SubAgent(SubAgentSource::ThreadSpawn {
            ...
            return lemurclaw_rollout_trace::ThreadTraceContext::disabled();
        };
        ...
        self.get_thread(*parent_thread_id)
            ...
            .unwrap_or_else(lemurclaw_rollout_trace::ThreadTraceContext::disabled)
    }
}
