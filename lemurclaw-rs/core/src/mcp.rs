...
use lemurclaw_connectors::PluginConnectorSource;
...
use lemurclaw_extension_api::McpServerContribution;
use lemurclaw_extension_api::McpServerContributionContext;
use lemurclaw_login::CodexAuth;
use lemurclaw_mcp::CODEX_APPS_MCP_SERVER_NAME;
use lemurclaw_mcp::EffectiveMcpServer;
use lemurclaw_mcp::McpConfig;
use lemurclaw_mcp::McpPluginAttribution;
use lemurclaw_mcp::McpServerRegistration;
use lemurclaw_mcp::McpToolCatalogCache;
use lemurclaw_mcp::ToolInfo;
use lemurclaw_mcp::codex_apps_mcp_server_config;
use lemurclaw_mcp::configured_mcp_servers;
...
impl McpManager {
    pub fn new(plugins_manager: Arc<PluginsManager>) -> Self {
        Self::new_with_extensions(
            plugins_manager,
            lemurclaw_extension_api::empty_extension_registry(),
