...
use lemurclaw_protocol::protocol::TerminalInteractionEvent;
use lemurclaw_sandboxing::SandboxCommand;
use lemurclaw_tools::ToolName;
use lemurclaw_utils_output_truncation::approx_tokens_from_byte_count;
...
fn exec_server_env_for_request(
    ...
    Option<lemurclaw_exec_server::ExecEnvPolicy>,
    HashMap<String, String>,
) {
...
fn exec_server_params_for_request(
    ...
    tty: bool,
) -> lemurclaw_exec_server::ExecParams {
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        network_proxy_launch: Option<lemurclaw_network_proxy::RemoteNetworkProxyLaunchConfig>,
    ...
    pub(crate) async fn open_session_with_prepared_exec_env(
        ...
        let network_proxy_restricting_sid = {
            ...
            {
                if request.sandbox == lemurclaw_sandboxing::SandboxType::WindowsRestrictedToken {
                    request
                        .network
                        .as_ref()
                        .map(|network| {
        ...
        let windows_sandbox =
            if request.sandbox == lemurclaw_sandboxing::SandboxType::WindowsRestrictedToken {
                Some(lemurclaw_sandboxing::WindowsSandboxSpawnRequest {
        ...
        let spawn_result = lemurclaw_sandboxing::spawn_process(lemurclaw_sandboxing::SpawnRequest {
