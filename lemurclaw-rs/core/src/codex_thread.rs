...
use lemurclaw_exec_server::SelectedCapabilityRootsStatus;
...
use lemurclaw_thread_store::ThreadStoreResult;
...
impl CodexThread {
    ...
    pub(crate) async fn emit_thread_resume_lifecycle(&self) {
        ...
        {
            contributor
                .on_thread_resume(lemurclaw_extension_api::ThreadResumeInput {
    ...
    ) -> (lemurclaw_mcp::McpConfig, lemurclaw_mcp::McpRuntimeContext) {
    ...
    pub async fn current_mcp_config_and_runtime_context(
        &self,
    ) -> (Arc<lemurclaw_mcp::McpConfig>, lemurclaw_mcp::McpRuntimeContext) {
