...
/// `lemurclaw_feedback::CodexFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// lemurclaw_core::feedback_tags!(model = "gpt-5", cached = true);
/// lemurclaw_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
