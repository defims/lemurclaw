...
use lemurclaw_protocol::protocol::GuardianAssessmentAction;
...
use lemurclaw_protocol::protocol::McpStartupCompleteEvent;
use lemurclaw_protocol::protocol::McpStartupStatus;
use lemurclaw_protocol::protocol::McpStartupUpdateEvent;
...
use lemurclaw_protocol::request_user_input::RequestUserInputEvent;
...
async fn forward_ops_preserves_submission_trace_context() {
    ...
    let submission = Submission {
        ...
        trace: Some(lemurclaw_protocol::protocol::W3cTraceContext {
            traceparent: Some(
