...
use lemurclaw_config::ConfigEditsBuilder;
use lemurclaw_config::McpServerConfig;
use lemurclaw_config::McpServerTransportConfig;
use lemurclaw_config::load_global_mcp_servers;
use lemurclaw_login::default_client::is_first_party_originator;
...
use lemurclaw_rmcp_client::perform_oauth_login;
...
pub(crate) async fn maybe_prompt_and_install_mcp_dependencies(
    ...
    if mentioned_skills.is_empty()
        || !config
            .features
            .enabled(lemurclaw_features::Feature::SkillMcpDependencyInstall)
    {
        return;
    }
