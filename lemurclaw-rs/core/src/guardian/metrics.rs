...
use lemurclaw_otel::GUARDIAN_REVIEW_COUNT_METRIC;
use lemurclaw_otel::GUARDIAN_REVIEW_DURATION_METRIC;
use lemurclaw_otel::GUARDIAN_REVIEW_TOKEN_USAGE_METRIC;
use lemurclaw_otel::GUARDIAN_REVIEW_TTFT_DURATION_METRIC;
use lemurclaw_otel::SessionTelemetry;
use lemurclaw_otel::sanitize_metric_tag_value;
use lemurclaw_protocol::protocol::GuardianAssessmentOutcome;
    ...
    fn guardian_review_metrics_record_counts_durations_and_token_usage() {
        ...
        emit_guardian_review_metrics(
            ...
            &GuardianReviewedAction::NetworkAccess {
                protocol: lemurclaw_protocol::approvals::NetworkApprovalProtocol::Https,
                port: 443,
            },
