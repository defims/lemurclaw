...
use lemurclaw_rollout_trace::ExecutionStatus;
...
use lemurclaw_rollout_trace::RolloutTrace;
    ...
    let output = client
        .compact_conversation_history(
            ...
            CompactConversationRequestSettings {
                effort: None,
                summary: lemurclaw_protocol::config_types::ReasoningSummary::None,
                service_tier: None,
            },
...
fn output_message(id: &str, text: &str) -> ResponseItem {
    ResponseItem::Message {
        id: Some(lemurclaw_protocol::ResponseItemId::with_suffix("msg", id)),
