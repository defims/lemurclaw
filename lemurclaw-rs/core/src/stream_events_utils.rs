...
use lemurclaw_memories_read::citations::parse_memory_citation;
use lemurclaw_memories_read::citations::thread_ids_from_memory_citation;
use lemurclaw_protocol::error::CodexErr;
use lemurclaw_protocol::error::Result;
use lemurclaw_protocol::memory_citation::MemoryCitation;
...
use lemurclaw_utils_stream_parser::strip_proposed_plan_blocks;
use futures::Future;
use tracing::debug;
...
fn strip_hidden_assistant_markup_and_parse_memory_citation(
    ...
    String,
    Option<lemurclaw_protocol::memory_citation::MemoryCitation>,
) {
        ...
        && role == "assistant"
    {
        let combined = content
            ...
            .filter_map(|ci| match ci {
                lemurclaw_protocol::models::ContentItem::OutputText { text } => Some(text.as_str()),
                _ => None,
            })
            .collect::<String>();
...
pub(crate) async fn finalize_turn_item(
    ...
    if let TurnItem::AgentMessage(agent_message) = &mut *turn_item {
        ...
        agent_message.content =
            vec![lemurclaw_protocol::items::AgentMessageContent::Text { text: stripped }];
