...
use lemurclaw_protocol::items::WebSearchItem;
...
use lemurclaw_protocol::models::is_audio_close_tag_text;
use lemurclaw_protocol::models::is_audio_open_tag_text;
use lemurclaw_protocol::models::is_image_close_tag_text;
use lemurclaw_protocol::models::is_image_open_tag_text;
use lemurclaw_protocol::models::is_local_audio_close_tag_text;
use lemurclaw_protocol::models::is_local_audio_open_tag_text;
use lemurclaw_protocol::models::is_local_image_close_tag_text;
use lemurclaw_protocol::models::is_local_image_open_tag_text;
use lemurclaw_protocol::protocol::APPS_INSTRUCTIONS_OPEN_TAG;
use lemurclaw_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
use lemurclaw_protocol::protocol::CONTEXT_WINDOW_GUIDANCE_OPEN_TAG;
use lemurclaw_protocol::protocol::CONTEXT_WINDOW_OPEN_TAG;
...
use lemurclaw_protocol::protocol::PLUGINS_INSTRUCTIONS_OPEN_TAG;
use lemurclaw_protocol::protocol::REALTIME_CONVERSATION_OPEN_TAG;
use lemurclaw_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
use lemurclaw_protocol::protocol::TOOLS_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            lemurclaw_protocol::items::ImageGenerationItem {
