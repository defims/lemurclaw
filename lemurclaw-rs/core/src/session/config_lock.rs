...
use lemurclaw_config::config_toml::OrchestratorFeatureToml;
use lemurclaw_config::config_toml::OrchestratorToml;
...
use lemurclaw_features::RolloutBudgetConfigToml;
...
mod tests {
    ...
    async fn lock_contains_prompts_and_materializes_features() {
        ...
        for spec in lemurclaw_features::FEATURES {
            assert_eq!(
        ...
        assert_eq!(
            ...
            Some(FeatureToml::Config(CurrentTimeReminderConfigToml {
                ...
                clock_source: Some(lemurclaw_features::CurrentTimeSource::System),
                delivery_mode: Some(lemurclaw_features::CurrentTimeReminderDeliveryMode::AnyInference),
