...
pub(crate) struct Session {
    ...
    pub(super) mcp_elicitation_reviewer_handle: OnceLock<lemurclaw_mcp::ElicitationReviewerHandle>,
    pub(super) mcp_elicitation_lifecycle_handle: OnceLock<lemurclaw_mcp::ElicitationLifecycle>,
...
impl SessionConfiguration {
    ...
    pub(super) fn sandbox_policy(&self) -> SandboxPolicy {
        ...
        lemurclaw_sandboxing::compatibility_sandbox_policy_for_permission_profile(
            &permission_profile,
            self.cwd(),
        )
    }
            ...
            if let Some(active_permission_profile) = next_configuration.active_permission_profile()
            {
                ...
                config.permissions.network = config
                    ...
                    .map_err(|err| ConstraintError::InvalidValue {
                        ...
                        requirement_source: lemurclaw_config::RequirementSource::Unknown,
                    })?;
                config
                    .permissions
...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        config: Arc<Config>,
        user_instructions: Option<lemurclaw_extension_api::UserInstructions>,
        ...
        code_mode_session_provider: Arc<dyn lemurclaw_code_mode::CodeModeSessionProvider>,
        extensions: Arc<lemurclaw_extension_api::ExtensionRegistry<crate::config::Config>>,
        ...
        windows_sandbox_proxy_settings_mode: lemurclaw_sandboxing::WindowsSandboxProxySettingsMode,
        ...
        thread_extension_init.insert(lemurclaw_extension_api::ThreadOriginator(
            session_configuration.originator.clone(),
        ));
        let mcp_thread_init = thread_extension_init.clone();
        let thread_extension_data = lemurclaw_extension_api::ExtensionData::new_with_init(
            thread_id.to_string(),
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let trace_agent_path = session_configuration
                .session_source
                .get_agent_path()
                .unwrap_or_else(lemurclaw_protocol::AgentPath::root);
            let trace_task_name =
            ...
            let mcp_server_names =
                lemurclaw_mcp::effective_mcp_servers(
            ...
            let session_extension_data =
                lemurclaw_extension_api::ExtensionData::new(session_id.to_string());
            ...
            for contributor in extensions.thread_lifecycle_contributors() {
                contributor.on_thread_start(lemurclaw_extension_api::ThreadStartInput {
            ...
            let session_start_source = match &initial_history {
                InitialHistory::Resumed(_) => lemurclaw_hooks::SessionStartSource::Resume,
                InitialHistory::New | InitialHistory::Forked(_) => {
                    lemurclaw_hooks::SessionStartSource::Startup
                }
                InitialHistory::Cleared => lemurclaw_hooks::SessionStartSource::Clear,
            };
