...
use lemurclaw_core_plugins::TrustedPluginRoots;
...
use lemurclaw_sandboxing::policy_transforms::effective_network_sandbox_policy;
...
pub struct TurnContext {
    ...
    pub(crate) extension_data: Arc<lemurclaw_extension_api::ExtensionData>,
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
            lemurclaw_tools::unified_exec_feature_mode_for_features(per_turn_config.features.get()),
        ...
        let extension_data = Arc::new(lemurclaw_extension_api::ExtensionData::new(sub_id.clone()));
