...
use lemurclaw_config::McpServerOAuthConfig;
...
use lemurclaw_core_skills::SkillsLoadInput;
use lemurclaw_core_skills::SkillsService;
use lemurclaw_login::CodexAuth;
use lemurclaw_plugin::AppDeclaration;
...
fn remote_installed_plugin_in_marketplace(
    ...
    RemoteInstalledPlugin {
        ...
        installed_at: None,
        enabled: true,
        install_policy: lemurclaw_app_server_protocol::PluginInstallPolicy::Available,
        install_policy_source: None,
        must_show_installation_interstitial: None,
        auth_policy: lemurclaw_app_server_protocol::PluginAuthPolicy::OnUse,
        availability: lemurclaw_app_server_protocol::PluginAvailability::Available,
...
async fn build_remote_installed_plugin_marketplaces_from_cache_uses_remote_metadata() {
    ...
    plugin.install_policy = lemurclaw_app_server_protocol::PluginInstallPolicy::InstalledByDefault;
    plugin.auth_policy = lemurclaw_app_server_protocol::PluginAuthPolicy::OnInstall;
    plugin.interface = Some(lemurclaw_app_server_protocol::PluginInterface {
    ...
    assert_eq!(
        ...
        lemurclaw_app_server_protocol::PluginInstallPolicy::InstalledByDefault
    );
    assert_eq!(
        plugin.auth_policy,
        lemurclaw_app_server_protocol::PluginAuthPolicy::OnInstall
    );
