...
use lemurclaw_config::RemoveMarketplaceConfigOutcome;
use lemurclaw_config::remove_user_marketplace_config;
...
mod tests {
    use super::*;
    use lemurclaw_config::MarketplaceConfigUpdate;
    use lemurclaw_config::record_user_marketplace;
    ...
    fn remove_marketplace_sync_removes_config_and_installed_root() {
        ...
        let config =
            fs::read_to_string(codex_home.path().join(lemurclaw_config::CONFIG_TOML_FILE)).unwrap();
