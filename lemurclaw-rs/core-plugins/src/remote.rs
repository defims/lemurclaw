...
use lemurclaw_app_server_protocol::PluginAuthPolicy;
use lemurclaw_app_server_protocol::PluginAvailability;
use lemurclaw_app_server_protocol::PluginDisabledReason;
use lemurclaw_app_server_protocol::PluginInstallPolicy;
use lemurclaw_app_server_protocol::PluginInstallPolicySource;
use lemurclaw_app_server_protocol::PluginInterface;
use lemurclaw_app_server_protocol::ScheduledTaskSummary;
use lemurclaw_app_server_protocol::SkillInterface;
...
use lemurclaw_http_client::RouteAwareRequestError;
...
fn authenticated_request(
    ...
    request
        ...
        .headers(lemurclaw_model_provider::auth_provider_from_auth(auth).to_auth_headers())
