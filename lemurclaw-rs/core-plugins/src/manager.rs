...
use lemurclaw_config::clear_user_plugin;
use lemurclaw_config::set_user_plugin_enabled;
use lemurclaw_config::types::PluginConfig;
use lemurclaw_config::types::ToolSuggestDisabledTool;
use lemurclaw_config::types::ToolSuggestDiscoverableType;
use lemurclaw_core_skills::PluginSkillSnapshots;
use lemurclaw_core_skills::config_rules::skill_config_rules_from_stack;
use lemurclaw_core_skills::loader::MAX_CONCURRENT_ROOT_SCANS;
use lemurclaw_hooks::plugin_hook_declarations;
use lemurclaw_http_client::HttpClientFactory;
use lemurclaw_login::AuthManager;
use lemurclaw_login::CodexAuth;
use lemurclaw_model_provider::AMAZON_BEDROCK_PROVIDER_ID;
use lemurclaw_plugin::AppConnectorId;
use lemurclaw_plugin::PluginCapabilitySummary;
use lemurclaw_plugin::PluginId;
use lemurclaw_plugin::PluginIdError;
use lemurclaw_plugin::PluginTelemetryMetadata;
use lemurclaw_plugin::app_connector_ids_from_declarations;
use lemurclaw_plugin::prompt_safe_plugin_description;
use lemurclaw_protocol::auth::AuthMode;
use lemurclaw_protocol::protocol::HookEventName;
use lemurclaw_protocol::protocol::Product;
use lemurclaw_skills::SkillConfigRules;
...
use lemurclaw_utils_plugins::PluginIdentity;
...
impl PluginsManager {
    ...
    pub async fn read_plugin_detail_for_marketplace_plugin(
        ...
        let manifest =
            if lemurclaw_utils_plugins::find_plugin_manifest_path(source_path.as_path()).is_some() {
        ...
        let resolved_skills = load_plugin_skills_with_identity(
            ...
            &manifest,
            self.restriction_product,
            &lemurclaw_core_skills::config_rules::skill_config_rules_from_stack(
                &config.config_layer_stack,
            ),
            /*plugin_skill_snapshots*/ None,
            Arc::clone(&self.skill_root_scan_slots),
