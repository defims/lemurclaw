...
pub type LoadedPlugin = lemurclaw_plugin::LoadedPlugin<lemurclaw_config::McpServerConfig>;
pub type PluginLoadOutcome = lemurclaw_plugin::PluginLoadOutcome<lemurclaw_config::McpServerConfig>;
