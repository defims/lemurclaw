...
pub(crate) fn test_mcp_config(codex_home: PathBuf) -> McpConfig {
    McpConfig {
        ...
        config_layer_stack: lemurclaw_config::ConfigLayerStack::default(),
        approvals_reviewer: lemurclaw_config::types::ApprovalsReviewer::default(),
        ...
        connector_snapshot: lemurclaw_connectors::ConnectorSnapshot::default(),
    }
}
