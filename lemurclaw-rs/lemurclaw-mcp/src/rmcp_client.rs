...
use lemurclaw_async_utils::CancelErr;
...
use lemurclaw_rmcp_client::ExecutorStdioServerLauncher;
use lemurclaw_rmcp_client::LocalStdioServerLauncher;
use lemurclaw_rmcp_client::McpProtocolMode;
use lemurclaw_rmcp_client::RmcpClient;
use lemurclaw_rmcp_client::StdioServerLauncher;
use lemurclaw_rmcp_client::ToolWithConnectorId;
use lemurclaw_rmcp_client::is_authentication_required_error;
...
async fn make_rmcp_client(
    ...
    match transport {
        McpServerTransportConfig::Stdio {
            ...
            let cwd = cwd.map(lemurclaw_utils_path_uri::LegacyAppPathString::into_string);
