use anyhow::Context;
use anyhow::Result;
use lemurclaw_app_server_protocol::generate_json_with_experimental;
use lemurclaw_app_server_protocol::generate_typescript_schema_fixture_subtree_for_tests;
use lemurclaw_app_server_protocol::read_schema_fixture_subtree;
...
fn schema_root() -> Result<PathBuf> {
    ...
    let typescript_index = lemurclaw_utils_cargo_bin::find_resource!("schema/typescript/index.ts")
    ...
    let json_bundle =
        lemurclaw_utils_cargo_bin::find_resource!("schema/json/codex_app_server_protocol.schemas.json")
