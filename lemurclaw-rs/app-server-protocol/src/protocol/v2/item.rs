...
use lemurclaw_experimental_api_macros::ExperimentalApi;
use lemurclaw_extension_items::ExtensionItem;
pub use lemurclaw_extension_items::image_generation::ImageGenerationItem;
pub use lemurclaw_extension_items::sleep::SleepItem;
pub use lemurclaw_extension_items::web_search::WebSearchAction;
pub use lemurclaw_extension_items::web_search::WebSearchItem;
use lemurclaw_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use lemurclaw_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use lemurclaw_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
...
use lemurclaw_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use lemurclaw_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use lemurclaw_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use lemurclaw_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use lemurclaw_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: lemurclaw_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        lemurclaw_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        lemurclaw_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        lemurclaw_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        lemurclaw_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<lemurclaw_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: lemurclaw_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<lemurclaw_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: lemurclaw_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for lemurclaw_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
