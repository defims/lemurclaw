...
use lemurclaw_protocol::items::McpToolCallError as CoreMcpToolCallError;
use lemurclaw_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use lemurclaw_protocol::mcp::McpServerInfo;
use lemurclaw_protocol::mcp::Resource as McpResource;
pub use lemurclaw_protocol::mcp::ResourceContent as McpResourceContent;
use lemurclaw_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use lemurclaw_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from lemurclaw_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from lemurclaw_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> lemurclaw_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => lemurclaw_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => lemurclaw_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => lemurclaw_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
