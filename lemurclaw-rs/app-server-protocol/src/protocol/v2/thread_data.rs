...
use lemurclaw_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use lemurclaw_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
use lemurclaw_protocol::protocol::ThreadSource as CoreThreadSource;
