...
use lemurclaw_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use lemurclaw_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use lemurclaw_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use lemurclaw_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use lemurclaw_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use lemurclaw_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use lemurclaw_protocol::models::LegacyReadWriteRoots;
...
use lemurclaw_utils_path_uri::PathConvention;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> lemurclaw_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<lemurclaw_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: lemurclaw_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            lemurclaw_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            lemurclaw_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            lemurclaw_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
