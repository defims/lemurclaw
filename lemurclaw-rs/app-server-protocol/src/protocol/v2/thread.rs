...
pub use lemurclaw_protocol::capabilities::CapabilityRootLocation;
pub use lemurclaw_protocol::capabilities::SelectedCapabilityRoot;
...
use lemurclaw_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use lemurclaw_protocol::protocol::TokenUsage as CoreTokenUsage;
use lemurclaw_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "lemurclaw_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
...
impl From<lemurclaw_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: lemurclaw_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> lemurclaw_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => lemurclaw_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => lemurclaw_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `lemurclaw_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
