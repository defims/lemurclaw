...
use lemurclaw_protocol::protocol::HookEventName as CoreHookEventName;
use lemurclaw_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use lemurclaw_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use lemurclaw_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use lemurclaw_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use lemurclaw_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use lemurclaw_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use lemurclaw_protocol::protocol::HookScope as CoreHookScope;
use lemurclaw_protocol::protocol::HookSource as CoreHookSource;
use lemurclaw_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
