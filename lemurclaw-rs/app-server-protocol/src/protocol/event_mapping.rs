    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                lemurclaw_protocol::protocol::AgentStatus::Errored(_)
                | lemurclaw_protocol::protocol::AgentStatus::NotFound => {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let lemurclaw_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
...
mod tests {
    ...
    use lemurclaw_protocol::protocol::CollabResumeBeginEvent;
    use lemurclaw_protocol::protocol::CollabResumeEndEvent;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: lemurclaw_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        assert_item_completed_server_notification(
            ...
            ItemCompletedNotification {
                ...
                item: ThreadItem::CollabAgentToolCall {
                    ...
                    agents_states: [(
                        receiver_id,
                        CollabAgentState::from(lemurclaw_protocol::protocol::AgentStatus::NotFound),
                    )]
                    .into_iter()
                    .collect(),
                },
