...
use lemurclaw_protocol::protocol::ReviewOutputEvent;
use lemurclaw_protocol::review_format::REVIEW_FALLBACK_MESSAGE;
use lemurclaw_protocol::review_format::render_review_output_text;
...
pub fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            ...
            lemurclaw_protocol::protocol::GuardianAssessmentStatus::Approved => {
