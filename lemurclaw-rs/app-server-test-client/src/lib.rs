...
use lemurclaw_app_server_protocol::SandboxPolicy;
...
use lemurclaw_otel::OtelProvider;
use lemurclaw_otel::current_span_w3c_trace_context;
use lemurclaw_protocol::dynamic_tools::normalize_dynamic_tool_specs;
            ...
            TestLoginMode::AmazonBedrock { api_key, region } => {
                ...
                let login_response: LoginAccountResponse = client.send_request(
                    ClientRequest::LoginAccount {
                        ...
                        params: lemurclaw_app_server_protocol::LoginAccountParams::AmazonBedrock {
                            api_key,
                            region,
                        },
                    },
...
impl CodexClient {
    ...
    fn login_account_chatgpt(&mut self) -> Result<LoginAccountResponse> {
        ...
        let request = ClientRequest::LoginAccount {
            request_id: request_id.clone(),
            params: lemurclaw_app_server_protocol::LoginAccountParams::Chatgpt {
                app_brand: None,
    ...
    fn login_account_chatgpt_device_code(&mut self) -> Result<LoginAccountResponse> {
        ...
        let request = ClientRequest::LoginAccount {
            request_id: request_id.clone(),
            params: lemurclaw_app_server_protocol::LoginAccountParams::ChatgptDeviceCode,
        };
...
impl TestClientTracing {
    async fn initialize(config_overrides: &[String]) -> Result<Self> {
        ...
        let otel_provider = lemurclaw_core::otel_init::build_provider(
            &config,
