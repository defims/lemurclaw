...
use lemurclaw_code_mode_protocol::CodeModeSession;
...
use lemurclaw_code_mode_protocol::CodeModeSessionResultFuture;
use lemurclaw_code_mode_protocol::CodeModeToolKind;
use lemurclaw_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use lemurclaw_code_mode_protocol::ExecuteRequest;
use lemurclaw_code_mode_protocol::ExecuteToPendingOutcome;
use lemurclaw_code_mode_protocol::FunctionCallOutputContentItem;
use lemurclaw_code_mode_protocol::ImageDetail;
use lemurclaw_code_mode_protocol::NotificationFuture;
use lemurclaw_code_mode_protocol::RuntimeResponse;
use lemurclaw_code_mode_protocol::StartedCell;
use lemurclaw_code_mode_protocol::ToolInvocationFuture;
use lemurclaw_code_mode_protocol::WaitOutcome;
use lemurclaw_code_mode_protocol::WaitRequest;
use lemurclaw_code_mode_protocol::WaitToPendingOutcome;
use lemurclaw_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: lemurclaw_protocol::ToolName {
