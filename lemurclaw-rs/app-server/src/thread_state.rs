...
use lemurclaw_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: lemurclaw_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<lemurclaw_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
    pub(crate) paginated_turns: Option<Vec<Turn>>,
    pub(crate) paginated_initial_turns_page: Option<lemurclaw_app_server_protocol::TurnsPage>,
    pub(crate) paginated_initial_turns_page_with_active_slot:
        Option<lemurclaw_app_server_protocol::TurnsPage>,
    pub(crate) resume_cursor_store: Option<Arc<dyn lemurclaw_thread_store::ThreadStore>>,
