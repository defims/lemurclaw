...
use lemurclaw_app_server_protocol::experimental_required_message;
...
impl MessageProcessor {
    ...
    pub(crate) fn new(args: MessageProcessorArgs) -> Self {
        ...
        let thread_store = lemurclaw_core::thread_store_from_config(config.as_ref(), state_db.clone());
        ...
        let thread_manager = Arc::new_cyclic(|thread_manager| {
            let manager = ThreadManager::new(
                config.as_ref(),
                auth_manager.clone(),
                lemurclaw_core::build_models_manager(config.as_ref(), auth_manager.clone()),
