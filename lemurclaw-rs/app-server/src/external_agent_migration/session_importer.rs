...
use lemurclaw_external_agent_migration::ExternalAgentConfigImportItemResult;
use lemurclaw_external_agent_migration::record_import_error;
use lemurclaw_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use lemurclaw_external_agent_migration::sessions::ExternalAgentSessionMigration;
use lemurclaw_external_agent_migration::sessions::ImportedExternalAgentSession;
use lemurclaw_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use lemurclaw_external_agent_migration::sessions::PendingSessionImport;
use lemurclaw_external_agent_migration::sessions::SessionMetadataMode;
use lemurclaw_external_agent_migration::sessions::detect_imported_cla_session_connectors;
use lemurclaw_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use lemurclaw_external_agent_migration::sessions::record_completed_session_imports;
...
impl ExternalAgentSessionImporter {
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: lemurclaw_login::default_client::originator().value,
