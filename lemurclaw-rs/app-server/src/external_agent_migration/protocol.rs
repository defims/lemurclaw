...
use lemurclaw_app_server_protocol::CommandMigration;
...
use lemurclaw_app_server_protocol::ExternalAgentConfigImportHistory;
...
use lemurclaw_app_server_protocol::HookMigration;
use lemurclaw_app_server_protocol::JSONRPCErrorError;
use lemurclaw_app_server_protocol::McpServerMigration;
use lemurclaw_app_server_protocol::MigrationDetails;
use lemurclaw_app_server_protocol::PluginsMigration;
use lemurclaw_app_server_protocol::SkillMigration;
use lemurclaw_app_server_protocol::SubagentMigration;
use lemurclaw_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use lemurclaw_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use lemurclaw_external_agent_migration::ExternalAgentConfigImportSuccess;
use lemurclaw_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use lemurclaw_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use lemurclaw_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use lemurclaw_external_agent_migration::NamedMigration;
use lemurclaw_external_agent_migration::PluginsMigration as CorePluginsMigration;
use lemurclaw_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| lemurclaw_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: lemurclaw_state::ExternalAgentConfigImportHistoryRecord,
