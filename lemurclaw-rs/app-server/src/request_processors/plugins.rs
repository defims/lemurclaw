...
use lemurclaw_analytics::PluginInstallSource;
use lemurclaw_app_server_protocol::PluginAvailability;
use lemurclaw_app_server_protocol::PluginInstallPolicy;
use lemurclaw_app_server_protocol::PluginSharePrincipalRole;
use lemurclaw_app_server_protocol::PluginShareTargetRole;
use lemurclaw_config::types::McpServerConfig;
use lemurclaw_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use lemurclaw_core_plugins::PluginListBackgroundTaskOptions;
use lemurclaw_core_plugins::is_openai_curated_marketplace_name;
use lemurclaw_core_plugins::loader::load_configured_plugin_mcp_servers;
use lemurclaw_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
use lemurclaw_core_plugins::remote::REMOTE_GLOBAL_MARKETPLACE_NAME;
use lemurclaw_core_plugins::remote::REMOTE_WORKSPACE_MARKETPLACE_NAME;
use lemurclaw_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME;
use lemurclaw_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_PRIVATE_MARKETPLACE_NAME;
use lemurclaw_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_UNLISTED_MARKETPLACE_NAME;
use lemurclaw_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use lemurclaw_core_plugins::remote::RemotePluginCatalogCacheMode;
use lemurclaw_core_plugins::remote::RemotePluginScope;
use lemurclaw_core_plugins::remote::is_valid_remote_plugin_id;
use lemurclaw_core_plugins::remote::validate_remote_plugin_id;
use lemurclaw_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use lemurclaw_mcp::McpOAuthLoginSupport;
use lemurclaw_mcp::McpRuntimeContext;
use lemurclaw_mcp::oauth_login_support;
use lemurclaw_mcp::should_retry_without_scopes;
use lemurclaw_plugin::PluginId;
use lemurclaw_plugin::PluginTelemetryMetadata;
use lemurclaw_protocol::auth::AuthMode as DomainAuthMode;
use lemurclaw_rmcp_client::OAuthDiscoveryTimeout;
use lemurclaw_rmcp_client::perform_oauth_login_silent;
...
pub(crate) struct PluginRequestProcessor {
    ...
    on_effective_plugins_changed:
        Arc<dyn Fn(lemurclaw_core_plugins::EffectivePluginsChange) + Send + Sync>,
}

fn plugin_skills_to_info(
    skills: &[lemurclaw_core::skills::SkillMetadata],
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                lemurclaw_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    lemurclaw_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
fn convert_configured_marketplace_plugin_to_plugin_summary(
    plugin: lemurclaw_core_plugins::ConfiguredMarketplacePlugin,
    shared_plugin_ids_by_local_path: &std::collections::BTreeMap<AbsolutePathBuf, String>,
) -> PluginSummary {
...
) -> lemurclaw_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            lemurclaw_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            lemurclaw_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            lemurclaw_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> lemurclaw_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Listed => {
            lemurclaw_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Listed
        }
        PluginShareUpdateDiscoverability::Unlisted => {
            lemurclaw_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            lemurclaw_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> lemurclaw_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            lemurclaw_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            lemurclaw_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: lemurclaw_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        lemurclaw_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        lemurclaw_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        lemurclaw_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<lemurclaw_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| lemurclaw_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        lemurclaw_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        lemurclaw_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        lemurclaw_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: lemurclaw_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    pub(crate) fn new(
        ...
        on_effective_plugins_changed: Arc<
            dyn Fn(lemurclaw_core_plugins::EffectivePluginsChange) + Send + Sync,
        >,
    ) -> Self {
        Self {
            auth_manager,
    ...
    async fn plugin_list_response(
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<lemurclaw_app_server_protocol::MarketplaceLoadErrorInfo>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        .errors
                        .into_iter()
                        .map(|err| lemurclaw_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match lemurclaw_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
        ...
        if !remote_sources.is_empty() {
            match lemurclaw_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<lemurclaw_core_plugins::PluginsManager>,
        config: &Config,
        plugins_input: &lemurclaw_core_plugins::PluginsConfigInput,
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        let remote_plugin_service_config = remote_plugin_service_config(&config);
                        match lemurclaw_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| lemurclaw_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = lemurclaw_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(lemurclaw_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_skill_read_response(
        ...
        let auth = self.auth_manager.auth().await;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_skill_detail = lemurclaw_core_plugins::remote::fetch_remote_plugin_skill_detail(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let access_policy = lemurclaw_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = lemurclaw_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codex_home.as_path(),
            &plugin_path,
        ...
        lemurclaw_core_plugins::remote::invalidate_cached_remote_plugin_catalog_scopes(
            config.codex_home.as_path(),
            &remote_plugin_service_config,
            auth.as_ref(),
    ...
    async fn plugin_share_update_targets_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = lemurclaw_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let (config, auth) = self.load_plugin_share_config_and_auth().await?;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let data = lemurclaw_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codex_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = lemurclaw_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codex_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        lemurclaw_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codex_home.as_path(),
            &remote_plugin_id,
    ...
    async fn remote_plugin_install_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_detail =
            lemurclaw_core_plugins::remote::fetch_remote_plugin_detail_with_download_urls(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_marketplace_name,
                &remote_plugin_id,
        ...
        let _remote_plugin_cache_mutation =
            lemurclaw_core_plugins::remote::mark_remote_plugin_cache_mutation_in_flight(
                config.codex_home.as_path(),
                &actual_remote_marketplace_name,
                &remote_plugin_name,
            );
        let validated_bundle = lemurclaw_core_plugins::remote_bundle::validate_remote_plugin_bundle(
            &remote_plugin_id,
            &actual_remote_marketplace_name,
            &remote_plugin_name,
        ...
        let result = lemurclaw_core_plugins::remote_bundle::download_and_install_remote_plugin_bundle(
            &remote_plugin_service_config,
        ...
        let install_result = lemurclaw_core_plugins::remote::install_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            &actual_remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        auth: Option<&CodexAuth>,
        plugin_id: &str,
        plugin_app_declarations: &[lemurclaw_plugin::AppDeclaration],
    ) -> Vec<AppSummary> {
        ...
        let plugin_apps =
            lemurclaw_plugin::app_connector_ids_from_declarations(plugin_app_declarations);
    ...
    async fn plugin_uninstall_response(
        ...
        if lemurclaw_plugin::PluginId::parse(&plugin_id).is_err()
    ...
    async fn remote_plugin_uninstall_response(
        ...
        let auth = self.auth_manager.auth().await;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let uninstall_target = lemurclaw_core_plugins::remote::resolve_remote_plugin_uninstall_target(
            &remote_plugin_service_config,
            auth.as_ref(),
            &plugin_id,
        )
        ...
        let uninstall_result = lemurclaw_core_plugins::remote::uninstall_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codex_home.to_path_buf(),
            uninstall_target,
...
async fn load_plugin_app_summaries(
    config: &Config,
    auth: Option<&CodexAuth>,
    plugin_apps: &[lemurclaw_plugin::AppConnectorId],
    ...
    if let Some(auth) = auth.filter(|auth| {
        ...
        metadata_by_id.extend(
            lemurclaw_connectors::ConnectorMetadataStore::new(
                config.chatgpt_base_url.clone(),
                auth.get_account_id(),
    ...
    app_ids
        ...
        .map(|app_id| {
            ...
            AppSummary {
                install_url: Some(lemurclaw_connectors::metadata::connector_install_url(
                    &name, &app_id,
                )),
                id: app_id,
                name,
...
fn plugin_app_category_by_id_from_value(value: &serde_json::Value) -> HashMap<String, String> {
    lemurclaw_core_plugins::loader::plugin_app_declarations_from_value(value)
        .into_iter()
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: lemurclaw_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: lemurclaw_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
