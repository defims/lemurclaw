...
use lemurclaw_cloud_config::cloud_config_bundle_loader;
...
use lemurclaw_utils_json_to_toml::json_to_toml;
...
impl ConfigManager {
    ...
    fn current_thread_config_loader(&self) -> Arc<dyn ThreadConfigLoader> {
        self.thread_config_loader
            ...
            .unwrap_or_else(|_| Arc::new(lemurclaw_config::NoopThreadConfigLoader))
    }
    ...
    pub(crate) async fn load_with_cli_overrides(
        ...
        let mut config = lemurclaw_core::config::ConfigBuilder::default()
    ...
    pub(crate) fn new_for_tests(
        ...
        Self::new(
            ...
            Arc::new(lemurclaw_config::NoopThreadConfigLoader),
        )
    }
