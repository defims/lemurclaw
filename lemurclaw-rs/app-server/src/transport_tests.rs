    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: lemurclaw_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        lemurclaw_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                lemurclaw_app_server_protocol::AdditionalFileSystemPermissions {
