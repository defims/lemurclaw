...
use lemurclaw_app_server_protocol::CommandExecutionRequestApprovalResponse;
use lemurclaw_app_server_protocol::CommandExecutionSource;
use lemurclaw_app_server_protocol::CommandExecutionStatus;
use lemurclaw_app_server_protocol::DeprecationNoticeNotification;
use lemurclaw_app_server_protocol::DynamicToolCallParams;
use lemurclaw_app_server_protocol::EnvironmentConnectionNotification;
use lemurclaw_app_server_protocol::ErrorNotification;
use lemurclaw_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use lemurclaw_app_server_protocol::FileChangeApprovalDecision;
use lemurclaw_app_server_protocol::FileChangeRequestApprovalParams;
use lemurclaw_app_server_protocol::FileChangeRequestApprovalResponse;
use lemurclaw_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use lemurclaw_app_server_protocol::GuardianWarningNotification;
use lemurclaw_app_server_protocol::HookCompletedNotification;
use lemurclaw_app_server_protocol::HookStartedNotification;
use lemurclaw_app_server_protocol::ItemCompletedNotification;
use lemurclaw_app_server_protocol::ItemStartedNotification;
use lemurclaw_app_server_protocol::McpServerElicitationAction;
use lemurclaw_app_server_protocol::McpServerElicitationRequestParams;
use lemurclaw_app_server_protocol::McpServerElicitationRequestResponse;
use lemurclaw_app_server_protocol::McpServerStartupState;
use lemurclaw_app_server_protocol::McpServerStatusUpdatedNotification;
use lemurclaw_app_server_protocol::ModelReroutedNotification;
use lemurclaw_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use lemurclaw_app_server_protocol::ModelVerificationNotification;
use lemurclaw_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use lemurclaw_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use lemurclaw_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use lemurclaw_app_server_protocol::PermissionsRequestApprovalParams;
use lemurclaw_app_server_protocol::PermissionsRequestApprovalResponse;
use lemurclaw_app_server_protocol::RawResponseCompletedNotification;
use lemurclaw_app_server_protocol::RawResponseItemCompletedNotification;
use lemurclaw_app_server_protocol::RequestId;
use lemurclaw_app_server_protocol::ServerNotification;
use lemurclaw_app_server_protocol::ServerRequestPayload;
use lemurclaw_app_server_protocol::ThreadGoalUpdatedNotification;
use lemurclaw_app_server_protocol::ThreadItem;
use lemurclaw_app_server_protocol::ThreadRealtimeClosedNotification;
use lemurclaw_app_server_protocol::ThreadRealtimeErrorNotification;
use lemurclaw_app_server_protocol::ThreadRealtimeItemAddedNotification;
use lemurclaw_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use lemurclaw_app_server_protocol::ThreadRealtimeSdpNotification;
use lemurclaw_app_server_protocol::ThreadRealtimeStartedNotification;
use lemurclaw_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use lemurclaw_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use lemurclaw_app_server_protocol::ThreadRollbackResponse;
use lemurclaw_app_server_protocol::ThreadSettingsUpdatedNotification;
use lemurclaw_app_server_protocol::ThreadStatus;
use lemurclaw_app_server_protocol::ThreadTokenUsage;
use lemurclaw_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use lemurclaw_app_server_protocol::ToolRequestUserInputOption;
use lemurclaw_app_server_protocol::ToolRequestUserInputParams;
use lemurclaw_app_server_protocol::ToolRequestUserInputQuestion;
use lemurclaw_app_server_protocol::ToolRequestUserInputResponse;
use lemurclaw_app_server_protocol::Turn;
use lemurclaw_app_server_protocol::TurnCompletedNotification;
use lemurclaw_app_server_protocol::TurnDiffUpdatedNotification;
...
use lemurclaw_app_server_protocol::TurnModerationMetadataNotification;
use lemurclaw_app_server_protocol::TurnPlanStep;
use lemurclaw_app_server_protocol::TurnPlanUpdatedNotification;
use lemurclaw_app_server_protocol::TurnStartedNotification;
use lemurclaw_app_server_protocol::TurnStatus;
use lemurclaw_app_server_protocol::WarningNotification;
use lemurclaw_app_server_protocol::build_item_from_guardian_event;
use lemurclaw_app_server_protocol::guardian_auto_approval_review_notification;
use lemurclaw_app_server_protocol::item_event_to_server_notification;
use lemurclaw_core::CodexThread;
use lemurclaw_core::ThreadManager;
use lemurclaw_protocol::ThreadId;
use lemurclaw_protocol::items::CollabAgentTool as CoreCollabAgentTool;
...
use lemurclaw_protocol::protocol::RealtimeEvent;
use lemurclaw_protocol::protocol::ReviewDecision;
use lemurclaw_protocol::protocol::SubAgentActivityKind;
...
use lemurclaw_protocol::protocol::TurnDiffEvent;
use lemurclaw_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use lemurclaw_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use lemurclaw_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use lemurclaw_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use lemurclaw_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use lemurclaw_sandboxing::policy_transforms::intersect_permission_profiles;
use lemurclaw_shell_command::parse_command::shlex_join;
use lemurclaw_utils_absolute_path::AbsolutePathBuf;
use lemurclaw_utils_path_uri::LegacyAppPathString;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                lemurclaw_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                lemurclaw_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                lemurclaw_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                lemurclaw_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == lemurclaw_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                lemurclaw_protocol::protocol::GuardianAssessmentStatus::Denied
                | lemurclaw_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                lemurclaw_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                lemurclaw_protocol::protocol::GuardianAssessmentStatus::InProgress
                | lemurclaw_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: lemurclaw_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: lemurclaw_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: lemurclaw_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: lemurclaw_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<CodexThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: lemurclaw_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            lemurclaw_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use anyhow::bail;
    use chrono::Utc;
    use lemurclaw_app_server_protocol::AutoReviewDecisionSource;
    use lemurclaw_app_server_protocol::GuardianApprovalReviewStatus;
    use lemurclaw_app_server_protocol::JSONRPCErrorError;
    use lemurclaw_app_server_protocol::ServerRequest;
    use lemurclaw_app_server_protocol::TurnPlanStepStatus;
    use lemurclaw_login::CodexAuth;
    use lemurclaw_protocol::AgentPath;
    use lemurclaw_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use lemurclaw_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use lemurclaw_protocol::items::DynamicToolCallItem;
    use lemurclaw_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use lemurclaw_protocol::items::SubAgentActivityItem;
    use lemurclaw_protocol::items::TurnItem as CoreTurnItem;
    use lemurclaw_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use lemurclaw_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    use lemurclaw_protocol::plan_tool::PlanItemArg;
    use lemurclaw_protocol::plan_tool::StepStatus;
    use lemurclaw_protocol::protocol::AgentMessageEvent;
    ...
    use lemurclaw_protocol::protocol::GuardianAssessmentStatus;
    use lemurclaw_protocol::protocol::ItemCompletedEvent;
    use lemurclaw_protocol::protocol::ItemStartedEvent;
    ...
    use lemurclaw_thread_store::StoredThreadHistory;
    use lemurclaw_utils_absolute_path::AbsolutePathBuf;
    use lemurclaw_utils_absolute_path::test_support::PathBufExt;
    use lemurclaw_utils_absolute_path::test_support::test_path_buf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: lemurclaw_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(lemurclaw_protocol::protocol::GuardianRiskLevel::Low),
                Some(lemurclaw_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(lemurclaw_protocol::protocol::GuardianRiskLevel::High),
                Some(lemurclaw_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(lemurclaw_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = lemurclaw_protocol::protocol::GuardianAssessmentAction::Command {
            source: lemurclaw_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: lemurclaw_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: lemurclaw_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(lemurclaw_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(lemurclaw_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    lemurclaw_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(lemurclaw_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(lemurclaw_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = lemurclaw_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: lemurclaw_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: lemurclaw_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            lemurclaw_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let thread_manager = Arc::new(
            lemurclaw_core::test_support::thread_manager_with_models_provider_and_home(
                CodexAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.codex_home.to_path_buf(),
                Arc::new(lemurclaw_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let lemurclaw_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(lemurclaw_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(lemurclaw_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(lemurclaw_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(lemurclaw_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let lemurclaw_core::NewThread {
            ...
            .start_thread(lemurclaw_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: lemurclaw_app_server_protocol::SubAgentActivityKind::Interrupted,
