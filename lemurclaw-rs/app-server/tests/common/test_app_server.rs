...
use lemurclaw_app_server_protocol::FsCopyParams;
use lemurclaw_app_server_protocol::FsCreateDirectoryParams;
use lemurclaw_app_server_protocol::FsGetMetadataParams;
use lemurclaw_app_server_protocol::FsReadDirectoryParams;
use lemurclaw_app_server_protocol::FsReadFileParams;
use lemurclaw_app_server_protocol::FsRemoveParams;
use lemurclaw_app_server_protocol::FsUnwatchParams;
use lemurclaw_app_server_protocol::FsWatchParams;
use lemurclaw_app_server_protocol::FsWriteFileParams;
...
use lemurclaw_app_server_protocol::JSONRPCNotification;
...
use lemurclaw_app_server_protocol::ModelProviderCapabilitiesReadParams;
...
use lemurclaw_app_server_protocol::ProcessKillParams;
use lemurclaw_app_server_protocol::ProcessSpawnParams;
use lemurclaw_app_server_protocol::RemoteControlClientsListParams;
use lemurclaw_app_server_protocol::RemoteControlClientsRevokeParams;
use lemurclaw_app_server_protocol::RemoteControlPairingStartParams;
use lemurclaw_app_server_protocol::RemoteControlPairingStatusParams;
...
use lemurclaw_app_server_protocol::ThreadRealtimeListVoicesParams;
...
use lemurclaw_exec_server::CODEX_EXEC_SERVER_NOISE_AUTH_TOKEN_ENV_VAR;
use lemurclaw_exec_server::CODEX_EXEC_SERVER_NOISE_CHATGPT_ACCOUNT_ID_ENV_VAR;
use lemurclaw_exec_server::CODEX_EXEC_SERVER_NOISE_ENVIRONMENT_ID_ENV_VAR;
use lemurclaw_exec_server::CODEX_EXEC_SERVER_NOISE_REGISTRY_URL_ENV_VAR;
use lemurclaw_exec_server::CODEX_EXEC_SERVER_URL_ENV_VAR;
...
impl TestAppServer {
    ...
    pub async fn send_experimental_feature_enablement_set_request(
        &mut self,
        params: lemurclaw_app_server_protocol::ExperimentalFeatureEnablementSetParams,
    ) -> anyhow::Result<i64> {
        let params = Some(serde_json::to_value(params)?);
    ...
    pub async fn build(self) -> anyhow::Result<TestAppServer> {
                ...
                let (auto_env, delayed_exec_server) = match exec_server_delay {
                    Some(added_delay) => {
                        ...
                        let exec_server_program =
                            lemurclaw_utils_cargo_bin::cargo_bin("exec-server")
        ...
        if !env_overrides
            ...
            && let Ok(code_mode_host_program) =
                lemurclaw_utils_cargo_bin::cargo_bin("codex-code-mode-host")
        {
        ...
        let program = match program {
            ...
            None => lemurclaw_utils_cargo_bin::cargo_bin("codex-app-server")
