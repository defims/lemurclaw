...
use lemurclaw_app_server_protocol::DynamicToolCallResponse;
use lemurclaw_app_server_protocol::DynamicToolCallStatus;
use lemurclaw_app_server_protocol::DynamicToolFunctionSpec;
use lemurclaw_app_server_protocol::DynamicToolNamespaceSpec;
...
async fn start_function_dynamic_tool_call(call_id: &str) -> Result<PendingDynamicToolCall> {
    ...
    let mut model_info =
        lemurclaw_core::test_support::construct_model_info_offline("mock-model", &config);
