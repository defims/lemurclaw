...
use lemurclaw_app_server::AppServerRuntimeOptions;
use lemurclaw_app_server::AppServerTransport;
use lemurclaw_app_server::AppServerWebsocketAuthSettings;
use lemurclaw_app_server::PluginStartupTasks;
use lemurclaw_app_server::RemoteControlStartupMode;
use lemurclaw_app_server::run_main_with_transport_options;
...
use lemurclaw_app_server_protocol::RemoteControlClient;
use lemurclaw_app_server_protocol::RemoteControlClientsListOrder;
use lemurclaw_app_server_protocol::RemoteControlClientsListParams;
use lemurclaw_app_server_protocol::RemoteControlClientsListResponse;
use lemurclaw_app_server_protocol::RemoteControlClientsRevokeParams;
use lemurclaw_app_server_protocol::RemoteControlClientsRevokeResponse;
use lemurclaw_app_server_protocol::RemoteControlConnectionStatus;
use lemurclaw_app_server_protocol::RemoteControlDisableResponse;
use lemurclaw_app_server_protocol::RemoteControlEnableResponse;
use lemurclaw_app_server_protocol::RemoteControlPairingStartParams;
use lemurclaw_app_server_protocol::RemoteControlPairingStartResponse;
use lemurclaw_app_server_protocol::RemoteControlPairingStatusParams;
use lemurclaw_app_server_protocol::RemoteControlPairingStatusResponse;
use lemurclaw_app_server_protocol::RemoteControlStatusChangedNotification;
use lemurclaw_app_server_protocol::RemoteControlStatusReadResponse;
...
use lemurclaw_state::RemoteControlEnrollmentRecord;
use lemurclaw_state::StateRuntime;
use lemurclaw_utils_cli::CliConfigOverrides;
...
async fn explicit_remote_control_startup_fails_when_disabled_by_requirements() -> Result<()> {
    ...
    let _codex_home_guard = EnvVarGuard::set("LEMURCLAW_HOME", codex_home.path().as_os_str());
