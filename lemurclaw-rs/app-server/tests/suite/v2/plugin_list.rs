...
use lemurclaw_app_server_protocol::HookTrustStatus;
        ...
        vec![PluginMarketplaceEntry {
            ...
            plugins: vec![
                PluginSummary {
                    ...
                    disabled_reason: None,
                    eligible_plan_types: None,
                    interface: Some(lemurclaw_app_server_protocol::PluginInterface {
...
async fn plugin_list_includes_remote_marketplaces_when_remote_plugin_enabled() -> Result<()> {
  ...
  "pagination": {
    ...
    assert_eq!(
        ...
        lemurclaw_app_server_protocol::PluginAvailability::Available
    );
    assert_eq!(
...
async fn assert_disabled_remote_plugin_metadata(
    ...
    assert_eq!(
        plugin.availability,
        lemurclaw_app_server_protocol::PluginAvailability::DisabledByAdmin
    );
