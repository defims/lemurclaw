...
use lemurclaw_app_server_protocol::Model;
use lemurclaw_app_server_protocol::ModelListParams;
use lemurclaw_app_server_protocol::ModelListResponse;
use lemurclaw_app_server_protocol::ModelServiceTier;
use lemurclaw_app_server_protocol::ModelUpgradeInfo;
use lemurclaw_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        lemurclaw_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
