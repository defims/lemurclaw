...
use lemurclaw_app_server_protocol::ThreadStatusChangedNotification;
...
async fn thread_fork_defers_inherited_active_goal_until_next_turn() -> Result<()> {
    ...
    assert_eq!(
        forked_goal.status,
        lemurclaw_state::ThreadGoalStatus::BudgetLimited
    );
    assert_eq!(
        state_db
            .thread_goals()
...
async fn assert_thread_fork_freezes_active_paginated_turn_as_interrupted(
    ...
    assert!(matches!(
        ...
        [
            ...
            RolloutLine {
                item: RolloutItem::ResponseItem(lemurclaw_protocol::models::ResponseItem::Message {
                    role,
                    ..
                }),
                ..
