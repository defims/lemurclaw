...
pub(crate) fn resolve_provider_auth(
    ...
    provider: &ModelProviderInfo,
) -> lemurclaw_protocol::error::Result<SharedAuthProvider> {
...
) -> lemurclaw_protocol::error::Result<ResolvedProviderAuth> {
...
fn bearer_auth_for_provider(
    provider: &ModelProviderInfo,
) -> lemurclaw_protocol::error::Result<Option<BearerAuthProvider>> {
...
#[cfg(test)]
mod tests {
    use lemurclaw_agent_identity::generate_agent_key_material;
    ...
    use lemurclaw_login::auth::login_with_chatgpt_auth_tokens;
