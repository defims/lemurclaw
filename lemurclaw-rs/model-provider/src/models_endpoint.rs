...
use lemurclaw_api::ModelsClient;
...
use lemurclaw_login::AuthEnvTelemetry;
use lemurclaw_login::AuthManager;
use lemurclaw_login::CodexAuth;
use lemurclaw_login::collect_auth_env_telemetry;
use lemurclaw_login::default_client::create_client_for_route_async;
use lemurclaw_model_provider_info::ModelProviderInfo;
use lemurclaw_models_manager::manager::ModelsEndpointClient;
use lemurclaw_models_manager::manager::ModelsEndpointFuture;
use lemurclaw_otel::TelemetryAuthMode;
use lemurclaw_protocol::error::CodexErr;
use lemurclaw_protocol::error::Result as CoreResult;
...
impl OpenAiModelsEndpoint {
    ...
    async fn list_models(
        ...
        let _timer =
            lemurclaw_otel::start_global_timer("codex.remote_models.fetch_update.duration_ms", &[]);
