...
use lemurclaw_otel::ORIGINATOR_TAG;
use lemurclaw_otel::bounded_originator_tag_value;
use lemurclaw_state::DbTelemetry;
use lemurclaw_state::DbTelemetryHandle;
...
pub(crate) fn recorder(metrics: lemurclaw_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {
