...
use lemurclaw_state::BackfillState;
use lemurclaw_state::BackfillStats;
use lemurclaw_state::BackfillStatus;
use lemurclaw_state::DB_ERROR_METRIC;
use lemurclaw_state::DB_METRIC_BACKFILL;
use lemurclaw_state::DB_METRIC_BACKFILL_DURATION_MS;
use lemurclaw_state::ExtractionOutcome;
use lemurclaw_state::ThreadMetadataBuilder;
use lemurclaw_state::apply_rollout_item;
use std::path::Path;
...
pub(crate) async fn backfill_sessions_with_lease(
    ...
    let metric_client = lemurclaw_otel::global();
