...
use crate::state_db;
use lemurclaw_file_search as file_search;
...
pub struct ThreadItem {
    ...
    pub section: Option<lemurclaw_state::ThreadSection>,
...
impl From<lemurclaw_state::Anchor> for Cursor {
    fn from(anchor: lemurclaw_state::Anchor) -> Self {
        let ts = anchor
            .ts
            .timestamp_nanos_opt()
...
///
/// Directory layout: `~/.lemurclaw/sessions/YYYY/MM/DD/rollout-YYYY-MM-DDThh-mm-ss-<uuid>.jsonl`
...
async fn find_thread_path_by_id_str_in_subdir(
    ...
    subdir: &str,
    id_str: &str,
    state_db_ctx: Option<&lemurclaw_state::StateRuntime>,
