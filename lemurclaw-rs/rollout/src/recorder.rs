...
use lemurclaw_protocol::protocol::GitInfo as ProtocolGitInfo;
...
use lemurclaw_protocol::protocol::SessionContextWindow;
...
use lemurclaw_utils_path as path_utils;
...
///
/// ```ignore
/// $ jq -C . ~/.lemurclaw/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.lemurclaw/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
impl RolloutRecorder {
    ...
    async fn list_threads_with_db_fallback(
        ...
        lemurclaw_state::record_fallback("list_threads", "db_error", /*telemetry_override*/ None);
...
fn precompute_log_file_info(
    ...
    // Resolve ~/.lemurclaw/sessions/YYYY/MM/DD path.
...
impl From<lemurclaw_state::ThreadsPage> for ThreadsPage {
    fn from(db_page: lemurclaw_state::ThreadsPage) -> Self {
        let lemurclaw_state::ThreadsPage {
            items,
            parent_thread_ids,
            next_anchor,
            num_scanned_rows,
...
fn thread_item_from_state_metadata(
    item: lemurclaw_state::ThreadMetadata,
    parent_thread_id: Option<ThreadId>,
) -> ThreadItem {
    ThreadItem {
...
async fn select_resume_path_from_db_page(
    page: &lemurclaw_state::ThreadsPage,
    filter_cwd: Option<&Path>,
    default_provider: &str,
) -> Option<PathBuf> {
    match filter_cwd {
