...
use lemurclaw_extension_api::ApprovalReviewContributor;
use lemurclaw_extension_api::ConfigContributor;
use lemurclaw_extension_api::ContextContributor;
use lemurclaw_extension_api::ContextualUserFragment;
...
use lemurclaw_extension_api::SkillInvocationContributor;
use lemurclaw_extension_api::ThreadLifecycleContributor;
use lemurclaw_extension_api::TokenUsageContributor;
use lemurclaw_extension_api::ToolCall;
use lemurclaw_extension_api::ToolContributor;
use lemurclaw_extension_api::ToolExecutor;
use lemurclaw_extension_api::ToolLifecycleContributor;
use lemurclaw_extension_api::TurnContextContributionInput;
use lemurclaw_extension_api::TurnInputContext;
use lemurclaw_extension_api::TurnInputContributor;
use lemurclaw_extension_api::TurnItemContributor;
use lemurclaw_extension_api::TurnLifecycleContributor;
use lemurclaw_extension_api::empty_extension_registry;
use lemurclaw_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: lemurclaw_protocol::ThreadId::default(),
