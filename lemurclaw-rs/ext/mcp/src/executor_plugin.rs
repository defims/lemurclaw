use lemurclaw_connectors_extension::ExecutorPluginConnectorProvider;
use lemurclaw_core::config::Config;
use lemurclaw_core_plugins::ExecutorPluginProvider;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, lemurclaw_config::McpServerConfig)>,
