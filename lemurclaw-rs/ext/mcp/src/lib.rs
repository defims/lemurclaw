...
use lemurclaw_mcp::hosted_plugin_runtime_mcp_server_config;
...
impl McpServerContributor<Config> for HostedPluginRuntimeExtension {
    ...
    fn contribute<'a>(
        ...
        Box::pin(async move {
            ...
            if !config.features.enabled(lemurclaw_features::Feature::Apps) {
...
pub fn install_executor_plugins(
    ...
    environment_manager: std::sync::Arc<lemurclaw_exec_server::EnvironmentManager>,
) {
