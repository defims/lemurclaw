...
use lemurclaw_api::SearchClient;
use lemurclaw_api::SearchCommands;
use lemurclaw_api::SearchQuery;
use lemurclaw_api::SearchRequest;
use lemurclaw_api::SearchSettings;
use lemurclaw_core::X_CODEX_TURN_METADATA_HEADER;
use lemurclaw_core::web_search_action_detail;
use lemurclaw_extension_api::ExtensionTurnItem;
use lemurclaw_extension_api::FunctionCallError;
use lemurclaw_extension_api::ResponsesApiTool;
...
use lemurclaw_extension_api::parse_tool_input_schema_without_compaction;
use lemurclaw_extension_items::ExtensionItem;
use lemurclaw_extension_items::web_search::WebSearchAction;
use lemurclaw_extension_items::web_search::WebSearchItem;
use lemurclaw_login::default_client::add_originator_header;
use lemurclaw_login::default_client::create_client;
...
impl WebSearchTool {
    async fn handle_call(&self, call: ToolCall) -> Result<Box<dyn ToolOutput>, FunctionCallError> {
        ...
        if let Some(results) = results.as_ref()
            && let Some(metrics) = lemurclaw_otel::global()
