...
use lemurclaw_core_skills::build_available_skills;
use lemurclaw_core_skills::render::SkillRenderSideEffects;
...
use lemurclaw_extension_api::RenderedWorldStateFragment;
...
pub(crate) fn host_skills_world_state_section(
    ...
    let metadata_budget = match metadata_budget {
        SkillMetadataBudget::Tokens(limit) => lemurclaw_core_skills::SkillMetadataBudget::Tokens(limit),
        SkillMetadataBudget::Characters(limit) => {
            lemurclaw_core_skills::SkillMetadataBudget::Characters(limit)
        }
    };
