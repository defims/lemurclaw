...
use lemurclaw_core_skills::SKILLS_INTRO_WITH_ABSOLUTE_PATHS;
use lemurclaw_core_skills::SkillLoadOutcome;
use lemurclaw_core_skills::injection::InjectedHostSkillPrompts;
use lemurclaw_core_skills::loader::MAX_CONCURRENT_ROOT_SCANS;
use lemurclaw_core_skills::loader::SkillRoot;
use lemurclaw_core_skills::loader::load_skills_from_roots;
use lemurclaw_exec_server::LOCAL_FS;
use lemurclaw_extension_api::ConversationHistory;
...
use lemurclaw_extension_api::ExtensionRegistryBuilder;
use lemurclaw_extension_api::ExtensionWarning;
use lemurclaw_extension_api::NoopTurnItemEmitter;
use lemurclaw_extension_api::PreviousWorldStateSection;
use lemurclaw_extension_api::ThreadStartInput;
use lemurclaw_extension_api::ToolCall;
use lemurclaw_extension_api::ToolPayload;
use lemurclaw_extension_api::TurnInputContext;
use lemurclaw_extension_api::WorldStateContributionInput;
use lemurclaw_models_manager::model_info::model_info_from_slug;
...
use lemurclaw_protocol::capabilities::CapabilityRootLocation;
use lemurclaw_protocol::capabilities::SelectedCapabilityRoot;
use lemurclaw_protocol::protocol::Event;
use lemurclaw_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
use lemurclaw_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
...
use lemurclaw_skills::SkillMetadata;
use lemurclaw_skills_extension::HostSkillProvider;
use lemurclaw_skills_extension::SkillProviders;
use lemurclaw_skills_extension::SkillsExtensionConfig;
use lemurclaw_skills_extension::catalog::SkillAuthority;
use lemurclaw_skills_extension::catalog::SkillCatalog;
use lemurclaw_skills_extension::catalog::SkillCatalogEntry;
use lemurclaw_skills_extension::catalog::SkillPackageId;
use lemurclaw_skills_extension::catalog::SkillProviderError;
use lemurclaw_skills_extension::catalog::SkillReadResult;
use lemurclaw_skills_extension::catalog::SkillResourceId;
use lemurclaw_skills_extension::catalog::SkillSearchResult;
use lemurclaw_skills_extension::catalog::SkillSourceKind;
use lemurclaw_skills_extension::install;
use lemurclaw_skills_extension::install_with_providers;
use lemurclaw_skills_extension::provider::SkillListQuery;
use lemurclaw_skills_extension::provider::SkillProvider;
use lemurclaw_skills_extension::provider::SkillProviderFuture;
use lemurclaw_skills_extension::provider::SkillReadRequest;
use lemurclaw_skills_extension::provider::SkillSearchRequest;
...
async fn host_world_state_records_catalog_metrics_on_publish_and_change() -> TestResult {
    ...
    let sections = registry.context_contributors()[0]
        .contribute_world_state(WorldStateContributionInput {
            thread_id: lemurclaw_protocol::ThreadId::new(),
            turn_id: "turn-1",
            environments: &[],
