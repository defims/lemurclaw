...
use lemurclaw_api::ImageBackground;
use lemurclaw_api::ImageEditRequest;
use lemurclaw_api::ImageGenerationRequest;
use lemurclaw_api::ImageQuality;
use lemurclaw_api::ImageUrl;
...
use lemurclaw_extension_api::ExtensionTurnItem;
use lemurclaw_extension_api::FunctionCallError;
use lemurclaw_extension_api::ToolCall;
use lemurclaw_extension_api::ToolEnvironment;
...
use lemurclaw_extension_api::parse_tool_input_schema;
...
use lemurclaw_utils_image::PromptImageMode;
use lemurclaw_utils_image::load_for_prompt_bytes;
...
impl ToolExecutor<ToolCall> for ImageGenerationTool {
    ...
    fn handle(&self, call: ToolCall) -> lemurclaw_extension_api::ToolExecutorFuture<'_> {
