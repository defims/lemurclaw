 ...
 *  lemurclaw TUI's SlashCommand enum that applies to a web GUI.
 *
...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  {
    name: 'init',
    description: 'Create an AGENTS.md file with instructions for lemurclaw',
    category: 'sendTurn',
    dispatch: () => ({
      kind: 'sendTurn',
  ...
  {
    name: 'permissions',
    description: 'Choose what lemurclaw is allowed to do',
  ...
  {
    name: 'skills',
    description: 'Use skills to improve how lemurclaw performs specific tasks',
    category: 'openSettings',
  ...
  {
    name: 'logout',
    description: 'Log out of lemurclaw',
    category: 'sendRequest',
    dispatch: (_args, ctx) => {
  ...
  {
    name: 'personality',
    description: 'Choose a communication style for lemurclaw',
    category: 'sendTurn',
    dispatch: (args) => ({
      kind: 'sendTurn',
