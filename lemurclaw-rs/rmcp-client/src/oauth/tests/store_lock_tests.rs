...
const STORE_LOCK_CONTENTION_EVENT_TARGET: &str = "lemurclaw_rmcp_client::oauth::store_lock::contention";
...
const LOCK_HOLDER_READY_PATH_ENV: &str = "LEMURCLAW_OAUTH_STORE_LOCK_CHILD_READY_PATH";
