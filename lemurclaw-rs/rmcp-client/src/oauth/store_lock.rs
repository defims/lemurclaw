...
const LOCK_CONTENTION_EVENT_TARGET: &str = "lemurclaw_rmcp_client::oauth::store_lock::contention";
...
impl OAuthStoreLock {
    pub(super) fn acquire(store: OAuthStore) -> Result<Self, OAuthStoreLockFailure> {
        ...
        // the default home (`~/.lemurclaw`), and if an embedder has no local home/filesystem authority
