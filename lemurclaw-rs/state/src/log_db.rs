...
//!
//! # async fn example(state_db: std::sync::Arc<lemurclaw_state::StateRuntime>) {
...
pub fn default_filter() -> Targets {
    Targets::new()
        ...
        .with_target("lemurclaw_api::responses_websocket_timing", LevelFilter::OFF)
        .with_target("lemurclaw_core::post_sampling_token_estimate", LevelFilter::OFF)
}
