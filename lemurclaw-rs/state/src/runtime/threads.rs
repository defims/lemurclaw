...
ON CONFLICT(id) DO NOTHING
        ...
        .bind(
            metadata
                .thread_source
                .as_ref()
                .map(lemurclaw_protocol::protocol::ThreadSource::as_str),
        )
...
mod tests {
    ...
    async fn apply_rollout_items_preserves_existing_git_branch_and_fills_missing_git_fields() {
        ...
        let items = vec![RolloutItem::SessionMeta(SessionMetaLine {
            ...
            git: Some(GitInfo {
                commit_hash: Some(lemurclaw_git_utils::GitSha::new("rollout-sha")),
    ...
    async fn apply_rollout_items_uses_override_updated_at_when_provided() {
        ...
        let items = vec![RolloutItem::EventMsg(EventMsg::TokenCount(
            lemurclaw_protocol::protocol::TokenCountEvent {
                info: Some(lemurclaw_protocol::protocol::TokenUsageInfo {
                    total_token_usage: lemurclaw_protocol::protocol::TokenUsage {
                        input_tokens: 0,
                    ...
                    last_token_usage: lemurclaw_protocol::protocol::TokenUsage::default(),
