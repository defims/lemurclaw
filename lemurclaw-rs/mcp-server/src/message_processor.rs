...
use lemurclaw_login::default_client::USER_AGENT_SUFFIX;
...
impl MessageProcessor {
    ...
    pub(crate) async fn new(
        ...
        lemurclaw_image_generation_extension::install(
            &mut extensions,
            auth_manager.clone(),
        ...
        let thread_manager = Arc::new(ThreadManager::new(
            ...
            lemurclaw_core::build_models_manager(config.as_ref(), auth_manager),
            ...
            lemurclaw_core::thread_store_from_config(config.as_ref(), state_db.clone()),
    ...
    async fn handle_cancelled_notification(&self, params: rmcp::model::CancelledNotificationParam) {
        ...
        if let Err(e) = codex_arc
            .submit_with_id(Submission {
                ...
                op: lemurclaw_protocol::protocol::Op::Interrupt,
