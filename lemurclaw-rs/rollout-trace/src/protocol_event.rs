...
use lemurclaw_protocol::protocol::ExecCommandStatus;
...
use lemurclaw_protocol::protocol::PatchApplyStatus;
use lemurclaw_protocol::protocol::SubAgentActivityEvent;
...
pub(crate) enum ToolRuntimePayload<'a> {
    ...
    CollabAgentSpawnBegin(&'a lemurclaw_protocol::protocol::CollabAgentSpawnBeginEvent),
    CollabAgentSpawnEnd(&'a lemurclaw_protocol::protocol::CollabAgentSpawnEndEvent),
    CollabAgentInteractionBegin(&'a lemurclaw_protocol::protocol::CollabAgentInteractionBeginEvent),
    CollabAgentInteractionEnd(&'a lemurclaw_protocol::protocol::CollabAgentInteractionEndEvent),
    CollabWaitingBegin(&'a lemurclaw_protocol::protocol::CollabWaitingBeginEvent),
    CollabWaitingEnd(&'a lemurclaw_protocol::protocol::CollabWaitingEndEvent),
    CollabCloseBegin(&'a lemurclaw_protocol::protocol::CollabCloseBeginEvent),
    CollabCloseEnd(&'a lemurclaw_protocol::protocol::CollabCloseEndEvent),
...
struct ExecCommandBeginTracePayload<'a> {
    ...
    command: &'a [String],
    cwd: String,
    parsed_cmd: &'a [lemurclaw_protocol::parse_command::ParsedCommand],
