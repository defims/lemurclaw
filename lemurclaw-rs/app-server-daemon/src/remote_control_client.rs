...
use lemurclaw_app_server_protocol::RemoteControlDisableParams;
use lemurclaw_app_server_protocol::RemoteControlDisableResponse;
use lemurclaw_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<lemurclaw_uds::UnixStream>> {
