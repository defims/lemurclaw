...
use lemurclaw_network_proxy::NetworkPolicyRequest;
use lemurclaw_network_proxy::NetworkProtocol;
...
use lemurclaw_windows_sandbox::ConsoleMode;
use lemurclaw_windows_sandbox::LocalSid;
use lemurclaw_windows_sandbox::create_process_as_user;
use lemurclaw_windows_sandbox::create_readonly_token_with_caps_and_user_from;
use lemurclaw_windows_sandbox::get_current_token_for_restriction;
...
const CHILD_MODE_ENV: &str = "LEMURCLAW_WINDOWS_PROXY_TEST_CHILD";
const HTTP_ADDR_ENV: &str = "LEMURCLAW_WINDOWS_PROXY_TEST_HTTP_ADDR";
const SOCKS_ADDR_ENV: &str = "LEMURCLAW_WINDOWS_PROXY_TEST_SOCKS_ADDR";
const ORIGIN_PORT_ENV: &str = "LEMURCLAW_WINDOWS_PROXY_TEST_ORIGIN_PORT";
const ALLOWED_HOST_ENV: &str = "LEMURCLAW_WINDOWS_PROXY_TEST_ALLOWED_HOST";
const DENIED_HOST_ENV: &str = "LEMURCLAW_WINDOWS_PROXY_TEST_DENIED_HOST";
