use lemurclaw_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use lemurclaw_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use lemurclaw_protocol::config_types::CollaborationModeMask;
use lemurclaw_protocol::config_types::ModeKind;
use lemurclaw_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
