...
use lemurclaw_config::types::KeybindingsSpec;
use lemurclaw_config::types::MAX_FUNCTION_KEY;
...
Set unique keys in `~/.lemurclaw/config.toml` and retry. \
...
Set a different key in `~/.lemurclaw/config.toml` and retry. \
See the Codex keymap documentation for supported actions and examples."
                ));
            }
        }
...
mod tests {
    use super::*;
    use lemurclaw_config::types::KeybindingSpec;
