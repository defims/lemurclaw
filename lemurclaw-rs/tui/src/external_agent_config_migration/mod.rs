...
mod tests {
    ...
    fn sample_plugin_details() -> lemurclaw_app_server_protocol::MigrationDetails {
        lemurclaw_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ...
            ExternalAgentConfigMigrationItem {
                ...
                cwd: None,
                details: Some(lemurclaw_app_server_protocol::MigrationDetails {
