...
use lemurclaw_app_server_protocol::HookOutputEntry;
use lemurclaw_app_server_protocol::HookOutputEntryKind;
use lemurclaw_app_server_protocol::HookRunStatus;
use lemurclaw_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
