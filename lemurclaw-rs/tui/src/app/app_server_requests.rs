...
mod tests {
    ...
    use lemurclaw_app_server_protocol::McpElicitationObjectType;
    use lemurclaw_app_server_protocol::McpElicitationSchema;
    ...
    use lemurclaw_app_server_protocol::PermissionGrantScope;
    use lemurclaw_app_server_protocol::PermissionsRequestApprovalParams;
    use lemurclaw_app_server_protocol::PermissionsRequestApprovalResponse;
    use lemurclaw_app_server_protocol::RequestId as AppServerRequestId;
    use lemurclaw_app_server_protocol::ServerRequest;
    use lemurclaw_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = lemurclaw_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: lemurclaw_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: lemurclaw_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: lemurclaw_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            lemurclaw_app_server_protocol::FileSystemSandboxEntry {
                                path: lemurclaw_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access: lemurclaw_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            lemurclaw_app_server_protocol::FileSystemSandboxEntry {
                                path: lemurclaw_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path).into(),
                                },
                                access: lemurclaw_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: lemurclaw_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: lemurclaw_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
