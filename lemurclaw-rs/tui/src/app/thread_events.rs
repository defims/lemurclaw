...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<lemurclaw_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use lemurclaw_app_server_protocol::HookEventName as AppServerHookEventName;
    use lemurclaw_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use lemurclaw_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use lemurclaw_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use lemurclaw_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use lemurclaw_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use lemurclaw_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use lemurclaw_app_server_protocol::HookScope as AppServerHookScope;
    use lemurclaw_app_server_protocol::HookStartedNotification;
    use lemurclaw_app_server_protocol::McpToolCallProgressNotification;
    use lemurclaw_app_server_protocol::RequestId as AppServerRequestId;
    use lemurclaw_app_server_protocol::ThreadRealtimeAudioChunk;
    ...
    fn thread_event_store_rebase_preserves_mcp_startup_notifications() {
        ...
        let notification = ServerNotification::McpServerStatusUpdated(
            lemurclaw_app_server_protocol::McpServerStatusUpdatedNotification {
                thread_id: Some(thread_id.to_string()),
                name: "sentry".to_string(),
                status: lemurclaw_app_server_protocol::McpServerStartupState::Failed,
