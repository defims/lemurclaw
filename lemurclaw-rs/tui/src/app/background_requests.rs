...
pub(super) async fn fetch_account_token_activity(
    request_handle: AppServerRequestHandle,
) -> Result<lemurclaw_app_server_protocol::GetAccountTokenUsageResponse> {
...
pub(super) async fn fetch_workspace_messages(
    request_handle: AppServerRequestHandle,
) -> Result<lemurclaw_app_server_protocol::GetWorkspaceMessagesResponse> {
...
pub(super) async fn send_add_credits_nudge_email(
    request_handle: AppServerRequestHandle,
    credit_type: AddCreditsNudgeCreditType,
) -> Result<lemurclaw_app_server_protocol::AddCreditsNudgeEmailStatus> {
    let request_id = RequestId::String(format!("add-credits-nudge-{}", Uuid::new_v4()));
    let response: lemurclaw_app_server_protocol::SendAddCreditsNudgeEmailResponse = request_handle
    ...
    request_handle
        .request_typed(ClientRequest::ConfigBatchWrite {
            ...
            params: ConfigBatchWriteParams {
                edits: vec![lemurclaw_app_server_protocol::ConfigEdit {
...
pub(super) type McpInventoryMaps = (
    HashMap<String, lemurclaw_protocol::mcp::Tool>,
    HashMap<String, Vec<lemurclaw_protocol::mcp::Resource>>,
    HashMap<String, Vec<lemurclaw_protocol::mcp::ResourceTemplate>>,
    ...
    for status in statuses {
        ...
        auth_statuses.insert(
            ...
            match status.auth_status {
                lemurclaw_app_server_protocol::McpAuthStatus::Unsupported => McpAuthStatus::Unsupported,
                lemurclaw_app_server_protocol::McpAuthStatus::NotLoggedIn => McpAuthStatus::NotLoggedIn,
                lemurclaw_app_server_protocol::McpAuthStatus::BearerToken => McpAuthStatus::BearerToken,
                lemurclaw_app_server_protocol::McpAuthStatus::OAuth => McpAuthStatus::OAuth,
            },
        );
