...
use lemurclaw_feedback::DOCTOR_REPORT_ATTACHMENT_FILENAME;
use lemurclaw_feedback::FEEDBACK_DIAGNOSTICS_ATTACHMENT_FILENAME;
use lemurclaw_feedback::FeedbackDiagnostics;
...
mod tests {
    ...
    use crate::app_event::AppEvent;
    use crate::app_event_sender::AppEventSender;
    use lemurclaw_feedback::FeedbackDiagnostic;
