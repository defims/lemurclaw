...
use lemurclaw_app_server_protocol::FileSystemAccessMode;
use lemurclaw_app_server_protocol::FileSystemPath;
use lemurclaw_app_server_protocol::FileSystemSandboxEntry;
use lemurclaw_app_server_protocol::FileSystemSpecialPath;
use lemurclaw_app_server_protocol::McpServerElicitationAction;
use lemurclaw_app_server_protocol::NetworkApprovalContext;
use lemurclaw_app_server_protocol::NetworkApprovalProtocol;
...
mod tests {
    ...
    use lemurclaw_app_server_protocol::ExecPolicyAmendment;
    use lemurclaw_app_server_protocol::NetworkApprovalProtocol;
    use lemurclaw_app_server_protocol::NetworkPolicyAmendment;
