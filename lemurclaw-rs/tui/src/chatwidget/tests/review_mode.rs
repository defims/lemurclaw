...
async fn interrupted_turn_after_goal_budget_limited_uses_budget_message_snapshot() {
    ...
    chat.handle_server_notification(
        lemurclaw_app_server_protocol::ServerNotification::TurnStarted(
            lemurclaw_app_server_protocol::TurnStartedNotification {
                thread_id: "thread-1".to_string(),
                turn: lemurclaw_app_server_protocol::Turn {
                    id: "turn-1".to_string(),
                    items_view: lemurclaw_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: lemurclaw_app_server_protocol::TurnStatus::InProgress,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
    ...
    chat.handle_server_notification(
        lemurclaw_app_server_protocol::ServerNotification::ThreadGoalUpdated(
            lemurclaw_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                goal: lemurclaw_app_server_protocol::ThreadGoal {
                    ...
                    status: lemurclaw_app_server_protocol::ThreadGoalStatus::BudgetLimited,
        ...
        lemurclaw_app_server_protocol::ServerNotification::TurnCompleted(
            lemurclaw_app_server_protocol::TurnCompletedNotification {
                ...
                turn: lemurclaw_app_server_protocol::Turn {
                    ...
                    items_view: lemurclaw_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: lemurclaw_app_server_protocol::TurnStatus::Interrupted,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
