...
use lemurclaw_app_server_protocol::MarketplaceLoadErrorInfo;
...
async fn plugin_detail_popup_snapshot_labels_personal_marketplace_as_local() {
    ...
    let mut plugin = plugins_test_detail(
        ...
        &[
            (lemurclaw_app_server_protocol::HookEventName::PreToolUse, 1),
            (lemurclaw_app_server_protocol::HookEventName::Stop, 2),
        ],
        &["Figma", "Slack"],
        &["figma-mcp", "docs-mcp"],
    );
...
async fn feedback_upload_consent_popup_snapshot() {
    ...
    chat.show_selection_view(crate::bottom_pane::feedback_upload_consent_params(
        ...
        &lemurclaw_feedback::FeedbackDiagnostics::new(vec![lemurclaw_feedback::FeedbackDiagnostic {
