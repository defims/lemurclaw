...
use lemurclaw_app_server_protocol::SpendControlLimitSnapshot;
...
fn update_thread_goal(chat: &mut ChatWidget, thread_id: ThreadId, status: AppThreadGoalStatus) {
    ...
    chat.handle_server_notification(
        ServerNotification::ThreadGoalUpdated(
            lemurclaw_app_server_protocol::ThreadGoalUpdatedNotification {
                thread_id,
                turn_id: None,
                goal,
            },
...
async fn interrupted_turn_clears_visible_running_hook() {
    ...
    handle_hook_started(
        ...
        hook_started_run(
            ...
            lemurclaw_app_server_protocol::HookEventName::PreToolUse,
...
async fn completed_turn_clears_visible_running_hook() {
    ...
    handle_hook_started(
        ...
        hook_started_run(
            ...
            lemurclaw_app_server_protocol::HookEventName::PostToolUse,
            /*status_message*/ None,
        ),
    );
    reveal_running_hooks(&mut chat);
...
async fn renamed_thread_footer_title_snapshot() {
    ...
    chat.handle_server_notification(
        ServerNotification::ThreadNameUpdated(
            lemurclaw_app_server_protocol::ThreadNameUpdatedNotification {
                thread_id: thread_id.to_string(),
        ...
        ServerNotification::ThreadGoalUpdated(
            lemurclaw_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                goal: test_thread_goal(
                    lemurclaw_app_server_protocol::ThreadGoalStatus::Active,
                    /*token_budget*/ Some(50_000),
                    /*tokens_used*/ 40_000,
                ),
            },
...
async fn status_line_goal_complete_elapsed_footer_snapshot() {
    ...
    chat.refresh_status_line();
    let mut goal = test_thread_goal(
        lemurclaw_app_server_protocol::ThreadGoalStatus::Complete,
        /*token_budget*/ None,
        /*tokens_used*/ 40_000,
    );
...
async fn thread_goal_update_for_other_thread_is_ignored() {
    ...
    let mut goal = test_thread_goal(
        lemurclaw_app_server_protocol::ThreadGoalStatus::BudgetLimited,
        /*token_budget*/ Some(50_000),
        /*tokens_used*/ 50_000,
    );
...
fn goal_status_indicator_formats_statuses_and_budgets() {
    ...
    assert_eq!(
        goal_status_indicator_from_app_goal(&test_thread_goal(
            lemurclaw_app_server_protocol::ThreadGoalStatus::Blocked,
            /*token_budget*/ None,
            /*tokens_used*/ 0,
        )),
    ...
    assert_eq!(
        goal_status_indicator_from_app_goal(&test_thread_goal(
            lemurclaw_app_server_protocol::ThreadGoalStatus::UsageLimited,
            /*token_budget*/ None,
            /*tokens_used*/ 0,
        )),
...
fn test_thread_goal(
    status: lemurclaw_app_server_protocol::ThreadGoalStatus,
    token_budget: Option<i64>,
    tokens_used: i64,
) -> lemurclaw_app_server_protocol::ThreadGoal {
    lemurclaw_app_server_protocol::ThreadGoal {
        thread_id: "thread-1".to_string(),
...
async fn blocked_and_failed_hooks_render_feedback_and_errors() {
    ...
    handle_hook_completed(
        ...
        hook_completed_run(
            ...
            vec![lemurclaw_app_server_protocol::HookOutputEntry {
                kind: lemurclaw_app_server_protocol::HookOutputEntryKind::Feedback,
    ...
    handle_hook_completed(
        ...
        hook_completed_run(
            ...
            vec![lemurclaw_app_server_protocol::HookOutputEntry {
                kind: lemurclaw_app_server_protocol::HookOutputEntryKind::Error,
...
async fn completed_same_id_hook_output_survives_restart() {
    ...
    handle_hook_started(
        ...
        hook_started_run(
            hook_id,
            lemurclaw_app_server_protocol::HookEventName::Stop,
    ...
    handle_hook_completed(
        ...
        hook_completed_run(
            ...
            vec![lemurclaw_app_server_protocol::HookOutputEntry {
                kind: lemurclaw_app_server_protocol::HookOutputEntryKind::Stop,
...
async fn hook_completed_before_reveal_renders_completed_without_running_flash() {
    ...
    handle_hook_started(
        ...
        hook_started_run(
            ...
            lemurclaw_app_server_protocol::HookEventName::SessionStart,
...
fn hook_run_summary(
    ...
    lemurclaw_app_server_protocol::HookRunSummary {
        ...
        started_at: 1,
        completed_at: (status != lemurclaw_app_server_protocol::HookRunStatus::Running).then_some(2),
        duration_ms: (status != lemurclaw_app_server_protocol::HookRunStatus::Running).then_some(1),
        entries,
    }
}
