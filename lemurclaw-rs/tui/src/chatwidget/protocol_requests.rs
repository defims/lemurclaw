...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: lemurclaw_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, lemurclaw_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                lemurclaw_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                lemurclaw_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                lemurclaw_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                lemurclaw_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                lemurclaw_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                lemurclaw_app_server_protocol::GuardianRiskLevel::Low => {
                    lemurclaw_protocol::approvals::GuardianRiskLevel::Low
                }
                lemurclaw_app_server_protocol::GuardianRiskLevel::Medium => {
                    lemurclaw_protocol::approvals::GuardianRiskLevel::Medium
                }
                lemurclaw_app_server_protocol::GuardianRiskLevel::High => {
                    lemurclaw_protocol::approvals::GuardianRiskLevel::High
                }
                lemurclaw_app_server_protocol::GuardianRiskLevel::Critical => {
                    lemurclaw_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    lemurclaw_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        lemurclaw_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    lemurclaw_app_server_protocol::GuardianUserAuthorization::Low => {
                        lemurclaw_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    lemurclaw_app_server_protocol::GuardianUserAuthorization::Medium => {
                        lemurclaw_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    lemurclaw_app_server_protocol::GuardianUserAuthorization::High => {
                        lemurclaw_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                lemurclaw_app_server_protocol::AutoReviewDecisionSource::Agent => {
