...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: lemurclaw_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<lemurclaw_protocol::openai_models::ReasoningEffort>,
