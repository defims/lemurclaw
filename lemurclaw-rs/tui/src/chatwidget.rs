...
use lemurclaw_app_server_protocol::CommandExecutionSource as ExecCommandSource;
...
use lemurclaw_app_server_protocol::ModelVerification as AppServerModelVerification;
use lemurclaw_app_server_protocol::RateLimitReachedType;
...
use lemurclaw_app_server_protocol::SkillMetadata;
use lemurclaw_app_server_protocol::SkillsListResponse;
use lemurclaw_app_server_protocol::ThreadGoal as AppThreadGoal;
use lemurclaw_app_server_protocol::ThreadGoalStatus as AppThreadGoalStatus;
...
use lemurclaw_config::Constrained;
use lemurclaw_config::ConstraintResult;
...
#[cfg(test)]
use lemurclaw_git_utils::CommitLogEntry;
use lemurclaw_git_utils::current_branch_name;
use lemurclaw_git_utils::get_git_repo_root;
use lemurclaw_git_utils::local_git_branches;
use lemurclaw_git_utils::recent_commits;
use lemurclaw_otel::RuntimeMetricsSummary;
use lemurclaw_otel::SessionTelemetry;
use lemurclaw_plugin::PluginCapabilitySummary;
use lemurclaw_protocol::ThreadId;
use lemurclaw_protocol::account::PlanType;
use lemurclaw_protocol::approvals::GuardianAssessmentAction;
use lemurclaw_protocol::approvals::GuardianAssessmentDecisionSource;
use lemurclaw_protocol::approvals::GuardianAssessmentEvent;
use lemurclaw_protocol::approvals::GuardianAssessmentStatus;
...
use lemurclaw_protocol::plan_tool::PlanItemArg as UpdatePlanItemArg;
use lemurclaw_protocol::plan_tool::StepStatus as UpdatePlanItemStatus;
use lemurclaw_protocol::request_permissions::RequestPermissionsEvent;
use lemurclaw_protocol::user_input::ByteRange;
use lemurclaw_protocol::user_input::TextElement;
use lemurclaw_terminal_detection::Multiplexer;
use lemurclaw_terminal_detection::TerminalInfo;
use lemurclaw_terminal_detection::TerminalName;
use lemurclaw_terminal_detection::terminal_info;
use lemurclaw_utils_absolute_path::AbsolutePathBuf;
use lemurclaw_utils_cli::resume_hint;
...
use lemurclaw_file_search::FileMatch;
...
use lemurclaw_utils_approval_presets::ApprovalPreset;
use lemurclaw_utils_approval_presets::builtin_approval_presets;
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) feedback: lemurclaw_feedback::CodexFeedback,
...
fn request_permissions_from_params(
    params: lemurclaw_app_server_protocol::PermissionsRequestApprovalParams,
...
impl ChatWidget {
    ...
    pub(crate) fn open_feedback_consent(&mut self, category: crate::app_event::FeedbackCategory) {
        ...
        let include_windows_sandbox_log =
            lemurclaw_windows_sandbox::current_log_file_path_for_codex_home(&self.config.codex_home)
                .is_file();
