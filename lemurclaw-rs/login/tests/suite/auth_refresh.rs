...
use lemurclaw_login::token_data::IdTokenInfo;
use lemurclaw_login::token_data::TokenData;
use lemurclaw_protocol::auth::AuthMode;
use lemurclaw_protocol::auth::RefreshTokenFailedReason;
...
async fn refresh_token_honors_respect_system_proxy() -> Result<()> {
    ...
    let auth_manager = AuthManager::shared(
        ...
        /*auth_route_config*/
        lemurclaw_login::AuthRouteConfig::from_http_client_factory(HttpClientFactory::new(
