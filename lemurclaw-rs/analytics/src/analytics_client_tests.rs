...
use lemurclaw_app_server_protocol::ApprovalsReviewer as AppServerApprovalsReviewer;
use lemurclaw_app_server_protocol::AskForApproval as AppServerAskForApproval;
...
use lemurclaw_app_server_protocol::DynamicToolCallStatus;
use lemurclaw_app_server_protocol::GuardianApprovalReview;
use lemurclaw_app_server_protocol::GuardianApprovalReviewAction;
use lemurclaw_app_server_protocol::GuardianApprovalReviewStatus;
use lemurclaw_app_server_protocol::GuardianCommandSource as AppServerGuardianCommandSource;
use lemurclaw_app_server_protocol::ImageGenerationItem;
use lemurclaw_app_server_protocol::InitializeCapabilities;
use lemurclaw_app_server_protocol::InitializeParams;
use lemurclaw_app_server_protocol::ItemCompletedNotification;
use lemurclaw_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification;
use lemurclaw_app_server_protocol::ItemStartedNotification;
use lemurclaw_app_server_protocol::JSONRPCErrorError;
use lemurclaw_app_server_protocol::McpToolCallAppContext;
use lemurclaw_app_server_protocol::McpToolCallStatus;
use lemurclaw_app_server_protocol::NonSteerableTurnKind;
use lemurclaw_app_server_protocol::PatchApplyStatus;
use lemurclaw_app_server_protocol::PermissionsRequestApprovalParams;
use lemurclaw_app_server_protocol::RequestId;
use lemurclaw_app_server_protocol::RequestPermissionProfile;
use lemurclaw_app_server_protocol::SandboxPolicy as AppServerSandboxPolicy;
use lemurclaw_app_server_protocol::ServerNotification;
use lemurclaw_app_server_protocol::ServerRequest;
use lemurclaw_app_server_protocol::ServerResponse;
use lemurclaw_app_server_protocol::SessionSource as AppServerSessionSource;
use lemurclaw_app_server_protocol::SubAgentActivityKind;
...
use lemurclaw_app_server_protocol::ThreadSource as AppServerThreadSource;
use lemurclaw_app_server_protocol::ThreadStartResponse;
use lemurclaw_app_server_protocol::ThreadStatus as AppServerThreadStatus;
...
use lemurclaw_app_server_protocol::TurnStatus as AppServerTurnStatus;
...
use lemurclaw_app_server_protocol::WebSearchItem;
use lemurclaw_login::default_client::DEFAULT_ORIGINATOR;
use lemurclaw_login::default_client::originator;
use lemurclaw_plugin::AppConnectorId;
use lemurclaw_plugin::PluginCapabilitySummary;
use lemurclaw_plugin::PluginId;
use lemurclaw_plugin::PluginTelemetryMetadata;
use lemurclaw_protocol::approvals::NetworkApprovalProtocol;
...
use lemurclaw_protocol::models::PermissionProfile as CorePermissionProfile;
use lemurclaw_protocol::protocol::AskForApproval;
use lemurclaw_protocol::protocol::HookEventName;
use lemurclaw_protocol::protocol::HookRunStatus;
use lemurclaw_protocol::protocol::HookSource;
...
fn sample_turn_start_response(turn_id: &str) -> ClientResponsePayload {
    ClientResponsePayload::TurnStart(lemurclaw_app_server_protocol::TurnStartResponse {
        turn: Turn {
    ...
    ServerRequest::PermissionsRequestApproval {
        ...
        params: PermissionsRequestApprovalParams {
            ...
            permissions: RequestPermissionProfile {
                network: Some(lemurclaw_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: None,
            },
...
fn sample_guardian_review_completed(
    ...
    ServerNotification::ItemGuardianApprovalReviewCompleted(
        ItemGuardianApprovalReviewCompletedNotification {
            ...
            decision_source: lemurclaw_app_server_protocol::AutoReviewDecisionSource::Agent,
...
async fn analytics_flush_delivers_completed_turn_with_file_diff() {
    ...
    let auth_manager = lemurclaw_login::AuthManager::from_auth_for_testing(
        lemurclaw_login::CodexAuth::create_dummy_chatgpt_auth_for_testing(),
    );
...
async fn compaction_event_ingests_custom_fact() {
    ...
    let parent_thread_id =
        lemurclaw_protocol::ThreadId::from_string("22222222-2222-2222-2222-222222222222")
...
fn subagent_thread_started_thread_spawn_serializes_thread_lineage() {
    let parent_thread_id =
        lemurclaw_protocol::ThreadId::from_string("11111111-1111-1111-1111-111111111111")
            .expect("valid thread id");
    let forked_from_thread_id =
        lemurclaw_protocol::ThreadId::from_string("22222222-2222-4222-8222-222222222222")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
fn subagent_thread_started_other_serializes_explicit_parent_thread_id() {
    let parent_thread_id =
        lemurclaw_protocol::ThreadId::from_string("33333333-3333-4333-8333-333333333333")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
async fn subagent_events_keep_thread_originator_with_explicit_turn_connection() {
    ...
    let mut events = Vec::new();
    let parent_thread_id =
        lemurclaw_protocol::ThreadId::from_string("44444444-4444-4444-4444-444444444444")
            .expect("valid parent thread id");
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::SkillInvoked(SkillInvokedInput {
                ...
                invocations: vec![SkillInvocation {
                    ...
                    skill_scope: lemurclaw_protocol::protocol::SkillScope::User,
                    skill_path,
                    plugin_id: None,
