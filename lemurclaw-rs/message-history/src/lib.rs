...
//!
//! The history is stored at `~/.lemurclaw/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.lemurclaw`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.lemurclaw/history.jsonl` and ensure the parent directory exists.
