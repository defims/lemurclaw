...
use lemurclaw_connectors::ConnectorMetadata;
use lemurclaw_connectors::ConnectorMetadataStore;
use lemurclaw_connectors::ConnectorToolSummary;
use lemurclaw_connectors::DirectoryListResponse;
use lemurclaw_connectors::merge::merge_connectors;
use lemurclaw_connectors::merge::merge_plugin_connectors;
use lemurclaw_core::config::Config;
pub use lemurclaw_core::connectors::list_accessible_connectors_from_mcp_tools;
pub use lemurclaw_core::connectors::list_accessible_connectors_from_mcp_tools_with_environment_manager;
pub use lemurclaw_core::connectors::list_accessible_connectors_from_mcp_tools_with_mcp_manager;
pub use lemurclaw_core::connectors::list_accessible_connectors_from_mcp_tools_with_options;
pub use lemurclaw_core::connectors::list_accessible_connectors_from_mcp_tools_with_options_and_status;
pub use lemurclaw_core::connectors::list_cached_accessible_connectors_from_mcp_tools;
pub use lemurclaw_core::connectors::with_app_enabled_state;
...
pub async fn list_cached_all_connectors(
    ...
    let connectors = lemurclaw_connectors::cached_directory_connectors(&cache_context)?;
...
pub async fn list_all_connectors_with_options(
    ...
    let cache_context = connector_directory_cache_context(config, &auth);
    let connectors = lemurclaw_connectors::list_all_connectors_with_options(
        cache_context,
...
mod tests {
    use super::*;
    use lemurclaw_connectors::metadata::connector_install_url;
    use lemurclaw_plugin::AppConnectorId;
