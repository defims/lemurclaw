...
use lemurclaw_protocol::permissions::is_protected_metadata_name;
...
use lemurclaw_protocol::protocol::FileSystemSpecialPath;
use lemurclaw_protocol::protocol::WritableRoot;
        ...
        file_system_sandbox_policy
            ...
            .filter_map(|entry| {
                ...
                if project_subpath != Path::new(".git")
                    ...
                    && project_subpath != Path::new(".lemurclaw")
                {
                    return None;
                }
...
mod tests {
    ...
    fn writable_roots_under_symlinked_ancestors_bind_real_target() {
        ...
        let logical_codex = logical_home.join(".lemurclaw");
    ...
    fn missing_read_only_subpath_uses_empty_file_bind_data() {
        ...
        assert_empty_directory_mounted_read_only(&args.args, &workspace.join(".lemurclaw"));
    ...
    fn missing_project_root_metadata_carveouts_use_metadata_path_masks() {
        ...
        let dot_codex = path_to_string(&temp_dir.path().join(".lemurclaw"));
    ...
    fn mounts_dev_before_writable_dev_binds() {
        ...
        assert_eq!(
            ...
            vec![
                PathBuf::from("/.git"),
                PathBuf::from("/.agents"),
                PathBuf::from("/.lemurclaw"),
                PathBuf::from("/dev/.git"),
                PathBuf::from("/dev/.agents"),
                PathBuf::from("/dev/.lemurclaw"),
            ]
        );
        assert_eq!(
            args.args,
