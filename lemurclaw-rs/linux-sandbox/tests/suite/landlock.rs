...
use lemurclaw_core::exec::process_exec_tool_call;
...
async fn run_cmd_output(
    ...
    timeout_ms: u64,
) -> lemurclaw_protocol::exec_output::ExecToolCallOutput {
...
async fn run_cmd_result_with_writable_roots(
    ...
    network_access: bool,
) -> Result<lemurclaw_protocol::exec_output::ExecToolCallOutput> {
...
fn is_bwrap_unavailable_output(output: &lemurclaw_protocol::exec_output::ExecToolCallOutput) -> bool {
...
fn expect_denied(
    result: Result<lemurclaw_protocol::exec_output::ExecToolCallOutput>,
    context: &str,
) -> lemurclaw_protocol::exec_output::ExecToolCallOutput {
    match result {
        Ok(output) => {
