...
fn to_state_status(status: ThreadSpawnEdgeStatus) -> lemurclaw_state::DirectionalThreadSpawnEdgeStatus {
    match status {
        ThreadSpawnEdgeStatus::Open => lemurclaw_state::DirectionalThreadSpawnEdgeStatus::Open,
        ThreadSpawnEdgeStatus::Closed => lemurclaw_state::DirectionalThreadSpawnEdgeStatus::Closed,
    }
}
