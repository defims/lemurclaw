...
//! `lemurclaw_core::chat_completions::build_chat_completions_payload`), which
//! translates codex's [`lemurclaw_protocol::models::ResponseItem`] history into
...
use lemurclaw_client::EncodedJsonBody;
use lemurclaw_client::HttpTransport;
use lemurclaw_client::RequestCompression;
use http::HeaderMap;
...
impl<T: HttpTransport> ChatCompletionsClient<T> {
    ...
    pub fn with_telemetry(
        self,
        request: Option<Arc<dyn lemurclaw_client::RequestTelemetry>>,
