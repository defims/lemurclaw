//! Helpers for truncating tool and exec output using [`TruncationPolicy`](lemurclaw_protocol::protocol::TruncationPolicy).

use lemurclaw_protocol::models::FunctionCallOutputContentItem;
pub use lemurclaw_utils_string::approx_bytes_for_tokens;
pub use lemurclaw_utils_string::approx_token_count;
pub use lemurclaw_utils_string::approx_tokens_from_byte_count;
use lemurclaw_utils_string::truncate_middle_chars;
use lemurclaw_utils_string::truncate_middle_with_token_budget;

pub use lemurclaw_protocol::protocol::TruncationPolicy;
