...
pub async fn spawn_process(request: SpawnRequest<'_>) -> Result<SpawnedProcess> {
    if request.sandbox == SandboxType::WindowsRestrictedToken {
        #[cfg(target_os = "windows")]
        {
            ...
            return lemurclaw_windows_sandbox::spawn_windows_sandbox_session_for_level(
                lemurclaw_windows_sandbox::WindowsSandboxSessionRequest {
    ...
    if request.tty {
        lemurclaw_utils_pty::pty::spawn_process(
            program,
            args,
            request.cwd,
            request.env,
        ...
        lemurclaw_utils_pty::pipe::spawn_process(
            program,
            args,
            request.cwd,
            request.env,
        ...
        lemurclaw_utils_pty::pipe::spawn_process_no_stdin(
            program,
            args,
            request.cwd,
            request.env,
