...
use lemurclaw_core_skills::loader::EnvironmentSkillMetadata;
use lemurclaw_core_skills::loader::load_environment_skills_from_discovery;
use lemurclaw_core_skills::loader::load_environment_skills_from_root;
use lemurclaw_exec_server::CapabilityRootDiscoverRequest;
use lemurclaw_exec_server::CapabilityRootsDiscoverParams;
...
use lemurclaw_exec_server::ExecutorFileSystemFuture;
use lemurclaw_exec_server::FileMetadata;
use lemurclaw_exec_server::FileSystemReadStream;
use lemurclaw_exec_server::FileSystemSandboxContext;
use lemurclaw_exec_server::LOCAL_FS;
use lemurclaw_exec_server::ReadDirectoryEntry;
use lemurclaw_exec_server::RemoveOptions;
use lemurclaw_exec_server::WalkOptions;
use lemurclaw_exec_server::WalkOutcome;
use lemurclaw_exec_server::discover_capability_roots;
...
async fn host_loading_reuses_walk_inventory_for_symlinked_skill_pack() {
    ...
    use lemurclaw_core_skills::SkillMetadata;
    use lemurclaw_core_skills::SkillPolicy;
    ...
    let future = load_skills_from_roots(
        [SkillRoot {
            ...
            plugin_root: None,
            discovery_mode: lemurclaw_utils_plugins::SkillDiscoveryMode::Recursive,
        }],
