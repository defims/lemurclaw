...
use lemurclaw_core::config::load_global_mcp_servers;
use lemurclaw_core_plugins::PluginsManager;
use lemurclaw_exec_server::EnvironmentManager;
use lemurclaw_exec_server::HttpClient;
use lemurclaw_exec_server::RouteAwareHttpClient;
use lemurclaw_login::AuthManager;
use lemurclaw_mcp::McpOAuthLoginSupport;
use lemurclaw_mcp::McpRuntimeContext;
use lemurclaw_mcp::ResolvedMcpOAuthScopes;
use lemurclaw_mcp::compute_auth_statuses;
...
/// - `add`    — add a server launcher entry to `~/.lemurclaw/config.toml`
...
async fn perform_oauth_login_retry_without_scopes(
    name: &str,
    url: &str,
    store_mode: lemurclaw_config::types::OAuthCredentialsStoreMode,
    keyring_backend_kind: lemurclaw_config::types::AuthKeyringBackendKind,
