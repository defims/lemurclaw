...
use lemurclaw_core_plugins::PluginMarketplaceUpgradeOutcome;
...
use lemurclaw_core_plugins::marketplace::marketplace_root_dir;
use lemurclaw_core_plugins::marketplace_add::MarketplaceAddOutcome;
use lemurclaw_core_plugins::marketplace_add::MarketplaceAddRequest;
use lemurclaw_core_plugins::marketplace_add::add_marketplace;
use lemurclaw_core_plugins::marketplace_remove::MarketplaceRemoveOutcome;
use lemurclaw_core_plugins::marketplace_remove::MarketplaceRemoveRequest;
...
impl JsonMarketplaceListOutput {
    fn from_marketplaces(
        marketplaces: Vec<lemurclaw_core_plugins::marketplace::Marketplace>,
