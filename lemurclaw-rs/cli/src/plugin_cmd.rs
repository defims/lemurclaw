...
use lemurclaw_core_plugins::ConfiguredMarketplace;
use lemurclaw_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
use lemurclaw_core_plugins::PluginInstallOutcome;
...
use lemurclaw_core_plugins::allowed_configured_marketplace_names;
use lemurclaw_core_plugins::installed_marketplaces::marketplace_install_root;
use lemurclaw_core_plugins::installed_marketplaces::resolve_configured_marketplace_root;
use lemurclaw_core_plugins::marketplace::MarketplaceListError;
use lemurclaw_core_plugins::marketplace::MarketplacePluginAuthPolicy;
use lemurclaw_core_plugins::marketplace::MarketplacePluginInstallPolicy;
use lemurclaw_core_plugins::marketplace::MarketplacePluginSource;
use lemurclaw_core_plugins::marketplace::find_marketplace_manifest_path;
use lemurclaw_login::CodexAuth;
use lemurclaw_login::auth::read_codex_api_key_from_env;
use lemurclaw_plugin::PluginId;
use lemurclaw_plugin::validate_plugin_segment;
        ...
        for (index, marketplace) in marketplaces.into_iter().enumerate() {
            ...
            for plugin in &marketplace.plugins {
                ...
                let path = match &plugin.source {
                    lemurclaw_core_plugins::marketplace::MarketplacePluginSource::Local { path } => {
                        path.as_path().display().to_string()
                    }
                    lemurclaw_core_plugins::marketplace::MarketplacePluginSource::Git {
                        url,
                        path,
                        ref_name,
                        sha,
                    ...
                    lemurclaw_core_plugins::marketplace::MarketplacePluginSource::Npm {
                        package,
                        version,
                        registry,
                    } => {
...
impl JsonPluginListOutput {
    fn from_marketplaces(
        marketplaces: Vec<lemurclaw_core_plugins::ConfiguredMarketplace>,
