...
use lemurclaw_code_mode::FunctionCallOutputContentItem;
use lemurclaw_code_mode::NotificationFuture;
use lemurclaw_code_mode::ProcessOwnedCodeModeSessionProvider;
use lemurclaw_code_mode::RuntimeResponse;
use lemurclaw_code_mode::ToolDefinition;
use lemurclaw_code_mode::ToolInvocationFuture;
use lemurclaw_code_mode::WaitOutcome;
use lemurclaw_code_mode::WaitRequest;
use lemurclaw_code_mode::host::MAX_FRAME_BYTES;
...
async fn remote_session_persists_values_forwards_delegates_and_controls_cells() {
    let provider = ProcessOwnedCodeModeSessionProvider::with_host_program(
        lemurclaw_utils_cargo_bin::cargo_bin("codex-code-mode-host").expect("host binary"),
    );
