...
use anyhow::Context;
use anyhow::Result;
use lemurclaw_code_mode_protocol::host::Capability;
use lemurclaw_code_mode_protocol::host::CapabilitySet;
use lemurclaw_code_mode_protocol::host::ClientHello;
use lemurclaw_code_mode_protocol::host::ClientToHost;
use lemurclaw_code_mode_protocol::host::DelegateRequest;
use lemurclaw_code_mode_protocol::host::DelegateResponse;
use lemurclaw_code_mode_protocol::host::EncodedFrame;
use lemurclaw_code_mode_protocol::host::HostHello;
use lemurclaw_code_mode_protocol::host::HostRequest;
use lemurclaw_code_mode_protocol::host::HostResponse;
use lemurclaw_code_mode_protocol::host::HostToClient;
use lemurclaw_code_mode_protocol::host::MAX_FRAME_BYTES;
use lemurclaw_code_mode_protocol::host::ProtocolVersion;
use lemurclaw_code_mode_protocol::host::RequestId;
use lemurclaw_code_mode_protocol::host::SessionId;
use lemurclaw_code_mode_protocol::host::SupportedProtocolVersions;
use lemurclaw_code_mode_protocol::host::WireContentItem;
use lemurclaw_code_mode_protocol::host::WireExecuteRequest;
use lemurclaw_code_mode_protocol::host::WireResult;
use lemurclaw_code_mode_protocol::host::WireRuntimeResponse;
use lemurclaw_code_mode_protocol::host::WireToolDefinition;
use lemurclaw_code_mode_protocol::host::WireToolKind;
use lemurclaw_code_mode_protocol::host::WireToolName;
use futures::SinkExt;
...
impl HostHarness {
    async fn start() -> Result<Self> {
        let host_program = lemurclaw_utils_cargo_bin::cargo_bin("codex-code-mode-host")?;
