...
/// Base config deserialized from ~/.lemurclaw/config.toml.
...
pub use lemurclaw_protocol::protocol::RealtimeConversationVersion as RealtimeWsVersion;
pub use lemurclaw_protocol::protocol::RealtimeVoice;
