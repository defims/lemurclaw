...
Set a stable path to the skill CLI (default `CODEX_HOME` is `~/.lemurclaw`):

```
export CODEX_HOME="${CODEX_HOME:-$HOME/.lemurclaw}"
...
- Network/sandbox notes for fallback CLI mode: `references/lemurclaw-network.md`
