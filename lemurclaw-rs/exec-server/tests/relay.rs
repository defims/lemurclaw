...
use lemurclaw_exec_server::EnvironmentConnectionState;
use lemurclaw_exec_server::EnvironmentManager;
use lemurclaw_exec_server::EnvironmentReadyInfo;
use lemurclaw_exec_server::ExecParams;
use lemurclaw_exec_server::ExecResponse;
use lemurclaw_exec_server::ExecServerClient;
use lemurclaw_exec_server::ExecServerError;
use lemurclaw_exec_server::ExecServerRuntimePaths;
use lemurclaw_exec_server::FsReadFileParams;
use lemurclaw_exec_server::NoiseChannelIdentity;
use lemurclaw_exec_server::NoiseChannelPublicKey;
use lemurclaw_exec_server::NoiseRendezvousConnectArgs;
use lemurclaw_exec_server::NoiseRendezvousConnectBundle;
use lemurclaw_exec_server::NoiseRendezvousConnectProvider;
use lemurclaw_exec_server::ProcessId;
use lemurclaw_exec_server::RemoteEnvironmentConfig;
use lemurclaw_http_client::HttpClientFactory;
use lemurclaw_http_client::OutboundProxyPolicy;
use lemurclaw_http_client::cache_system_proxy_route_for_test;
...
fn static_registry_auth_provider() -> lemurclaw_api::SharedAuthProvider {
...
async fn deferred_noise_environment_connects_and_reconnects_with_fresh_bundle() -> Result<()> {
    ...
    let remote_environment = tokio::spawn(lemurclaw_exec_server::run_remote_environment(
        config,
        runtime_paths,
    ));
...
async fn remote_environment_routes_encrypted_exec_server_rpc() -> Result<()> {
    ...
    let client_args = NoiseRendezvousConnectArgs {
        ...
        http_client_factory: lemurclaw_http_client::HttpClientFactory::new(
