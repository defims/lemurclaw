...
use lemurclaw_exec_server::CAPABILITY_ROOTS_DISCOVER_METHOD;
use lemurclaw_exec_server::CapabilityRootDiscovery;
use lemurclaw_exec_server::CapabilityRootsDiscoverParams;
use lemurclaw_exec_server::CapabilityRootsDiscoverResponse;
