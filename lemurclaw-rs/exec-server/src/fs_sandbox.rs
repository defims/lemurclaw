...
use lemurclaw_sandboxing::SandboxExecRequest;
...
use lemurclaw_utils_absolute_path::canonicalize_preserving_symlinks;
...
mod tests {
    ...
    fn sandbox_cwd_rejects_cwd_dependent_profile_without_context_cwd() {
        ...
        let sandbox_context = lemurclaw_file_system::FileSystemSandboxContext::from_permission_profile(
    ...
    fn sandbox_context_with_cwd(
        ...
        lemurclaw_file_system::FileSystemSandboxContext::from_permission_profile_with_cwd(
            PermissionProfile::from_runtime_permissions(policy, NetworkSandboxPolicy::Restricted),
            cwd,
        )
    }
