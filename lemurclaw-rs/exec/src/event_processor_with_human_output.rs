...
use lemurclaw_protocol::num_format::format_with_separators;
use lemurclaw_protocol::protocol::SessionConfiguredEvent;
use lemurclaw_utils_sandbox_summary::summarize_permission_profile;
            ...
            ServerNotification::TurnPlanUpdated(notification) => {
                ...
                for step in notification.plan {
                    match step.status {
                        ...
                        lemurclaw_app_server_protocol::TurnPlanStepStatus::InProgress => {
                            eprintln!("  {} {}", "→".style(self.cyan), step.step);
                        }
                        lemurclaw_app_server_protocol::TurnPlanStepStatus::Pending => {
                            eprintln!(
                                "  {} {}",
                                "•".style(self.dimmed),
