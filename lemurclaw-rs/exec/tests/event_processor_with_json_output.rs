use lemurclaw_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use lemurclaw_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use lemurclaw_app_server_protocol::CollabAgentTool;
use lemurclaw_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use lemurclaw_app_server_protocol::CommandAction;
use lemurclaw_app_server_protocol::CommandExecutionSource;
use lemurclaw_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use lemurclaw_app_server_protocol::ErrorNotification;
use lemurclaw_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use lemurclaw_app_server_protocol::ItemCompletedNotification;
use lemurclaw_app_server_protocol::ItemStartedNotification;
use lemurclaw_app_server_protocol::McpToolCallError;
use lemurclaw_app_server_protocol::McpToolCallResult;
use lemurclaw_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use lemurclaw_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use lemurclaw_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use lemurclaw_app_server_protocol::WebSearchAction as ApiWebSearchAction;
use lemurclaw_app_server_protocol::WebSearchItem as ApiWebSearchItem;
use lemurclaw_protocol::SessionId;
use lemurclaw_protocol::ThreadId;
use lemurclaw_protocol::models::PermissionProfile;
use lemurclaw_protocol::models::WebSearchAction;
...
use lemurclaw_exec::AgentMessageItem;
use lemurclaw_exec::CodexStatus;
use lemurclaw_exec::CollabAgentState;
use lemurclaw_exec::CollabAgentStatus;
use lemurclaw_exec::CollabTool;
use lemurclaw_exec::CollabToolCallItem;
use lemurclaw_exec::CollabToolCallStatus;
use lemurclaw_exec::CollectedThreadEvents;
use lemurclaw_exec::CommandExecutionItem;
use lemurclaw_exec::CommandExecutionStatus;
use lemurclaw_exec::ErrorItem;
use lemurclaw_exec::EventProcessorWithJsonOutput;
use lemurclaw_exec::ExecThreadItem;
use lemurclaw_exec::FileChangeItem;
use lemurclaw_exec::FileUpdateChange as ExecFileUpdateChange;
use lemurclaw_exec::ItemCompletedEvent;
use lemurclaw_exec::ItemStartedEvent;
use lemurclaw_exec::ItemUpdatedEvent;
use lemurclaw_exec::McpToolCallItem;
use lemurclaw_exec::McpToolCallItemError;
use lemurclaw_exec::McpToolCallItemResult;
use lemurclaw_exec::McpToolCallStatus;
use lemurclaw_exec::PatchApplyStatus;
use lemurclaw_exec::PatchChangeKind;
use lemurclaw_exec::ReasoningItem;
use lemurclaw_exec::ThreadErrorEvent;
use lemurclaw_exec::ThreadEvent;
use lemurclaw_exec::ThreadItemDetails;
use lemurclaw_exec::ThreadStartedEvent;
use lemurclaw_exec::TodoItem;
use lemurclaw_exec::TodoListItem;
use lemurclaw_exec::TurnCompletedEvent;
use lemurclaw_exec::TurnFailedEvent;
use lemurclaw_exec::TurnStartedEvent;
use lemurclaw_exec::Usage;
use lemurclaw_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        approvals_reviewer: lemurclaw_protocol::config_types::ApprovalsReviewer::User,
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            lemurclaw_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        lemurclaw_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: lemurclaw_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
