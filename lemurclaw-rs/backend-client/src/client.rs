...
use lemurclaw_http_client::RouteAwareRequestBuilder;
...
use lemurclaw_protocol::protocol::RateLimitReachedType;
use lemurclaw_protocol::protocol::RateLimitSnapshot;
use lemurclaw_protocol::protocol::RateLimitWindow;
use lemurclaw_protocol::protocol::SpendControlLimitSnapshot;
use http::Method;
use http::StatusCode;
...
impl Client {
    pub fn new(base_url: impl Into<String>, http_client_factory: HttpClientFactory) -> Self {
        ...
        Self {
            base_url,
            http,
            auth_provider: lemurclaw_model_provider::unauthenticated_auth_provider(),
            user_agent: None,
    ...
    pub fn from_auth(
        ...
        Self::new(base_url, http_client_factory)
            ...
            .with_auth_provider(lemurclaw_model_provider::auth_provider_from_auth(auth))
    }
    ...
    fn make_rate_limit_snapshot(
        ...
        spend_control: Option<lemurclaw_backend_openapi_models::models::SpendControlStatusDetails>,
...
mod tests {
    use super::*;
    use lemurclaw_backend_openapi_models::models::AdditionalRateLimitDetails;
    use lemurclaw_backend_openapi_models::models::RateLimitReachedKind;
    use lemurclaw_backend_openapi_models::models::RateLimitReachedType as BackendRateLimitReachedType;
    ...
    fn usage_payload_maps_primary_and_additional_rate_limits() {
        let payload = RateLimitStatusPayload {
            ...
            spend_control: Some(Some(Box::new(
                lemurclaw_backend_openapi_models::models::SpendControlStatusDetails {
                    reached: false,
    ...
    async fn user_settings_request_uses_expected_paths_and_revalidates_cached_responses() {
        ...
        let codex_response = Client::new(
            server.uri(),
            HttpClientFactory::new(lemurclaw_http_client::OutboundProxyPolicy::ReqwestDefault),
        )
        .get_user_settings()
        .await
        .unwrap();
