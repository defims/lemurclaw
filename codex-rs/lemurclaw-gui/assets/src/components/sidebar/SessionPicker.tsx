...
interface Props {
  ...
  /** Override the default resume dispatch (used by tests). */
  onSelect?: (thread: Thread) => void;
  /** Send a thread/resume ClientRequest via sendRequest and fold the response's
   *  cwd/model into state. Defaults to useConversation.resumeThread when no
   *  onSelect override is provided. */
...
export function SessionPicker({ activeThreadId, onSelect, onResume }: Props) {
